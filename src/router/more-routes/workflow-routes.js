...
const exampleRoutes = [
  {
    ...
    children: [
      ...
      {
        path: 'instanceInfoOld',
        component: () => import('@/views/workflow/instance/common/instanceInfoOld.vue'),
        name: 'instanceInfoOld',
        hidden: true // 不显示该路由到菜单上
      },
      {
        path: 'instanceInfoCallback',
        component: () => import('@/views/workflow/bench/callback/instanceInfoCallback.vue'),
        name: 'instanceInfoCallback',
        hidden: true // 不显示该路由到菜单上
      },
      {
