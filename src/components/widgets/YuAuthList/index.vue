...
export default {
  ...
  data() {
    return {
      roleUrl: backend.appOcaService + '/api/adminsmrole/page', // 角色列表请求url地址
      userUrl: backend.appOcaService + '/api/adminsmuser/page', // 用户列表请求url地址
      contentTabs: [
        { name: this.$t('roleDataPowerManager.jssq'), type: 'R', isChoose: true }
        // { name: this.$t('roleDataPowerManager.yhsq'), type: 'U', isChoose: false }  modify by wangyang at2021-07-01 隐藏用户授权
      ], // tab数组对象
