...
<div>
    ...
    <yu-xdialog title="检查表达式" :visible.sync="formulaDialog" width="880px" style="margin-left:-120px;" v-if="formulaDialog">
            ...
            <td width="167" valign="top" bgcolor="#FFFFFF">
              <table width="165" height="308" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td>
                    <div align="center">
                      <yu-button :plain="true" type="info" @click="inputStr('MAX()')" size="small">MAX</yu-button>
                      <yu-button :plain="true" type="info" @click="inputStr('MIN()')" size="small">MIN</yu-button>
                      <yu-button :plain="true" type="info" @click="inputStr('INT()')" size="small">INT</yu-button>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div align="center">
                      <yu-button :plain="true" type="info" @click="inputStr('@OPER(==)')" size="small">=</yu-button>
                      <yu-button :plain="true" type="info" @click="inputStr('@OPER(>)')" size="small">></yu-button>
                      <yu-button :plain="true" type="info" @click="inputStr('@OPER(>=)')" size="small">≥</yu-button>
                      <yu-button :plain="true" type="info" @click="inputStr('@OPER(<)')" size="small">{{ small }}</yu-button>
                      <yu-button :plain="true" type="info" @click="inputStr('@OPER(<=)')" size="small">≤</yu-button>
                    </div>
                  </td>
                </tr>
...
export default {
  ...
  methods: {
    ...
    check: function () {
      ...
      var oper = this.getParam(formula, '(', ')');
      formula = this.replaceAll(formula, '(' + oper + ')', '');
