  ...
  methods: {
    getDefaultData: function () {
      return {
        ...
        tempNodekeys: [],
        tempTreeData: [],
        dataUrl: backend.cmisCfg + '/api/cfgprdcatalog/tree',
