<template>
  <div>
    <yu-xdialog :visible.sync="visiable" :width="width" title="适用产品">
        ...
        <yu-xtable ref="refTable" request-type="get" :row-number="true" selection-type="radio" :pageable="true" :data-url="dataUrl" :default-load="true" condition-key="condition" :base-params="baseParams">
