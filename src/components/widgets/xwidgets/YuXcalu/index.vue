<template>
  <div>
    <yu-xdialog :visible.sync="visiable" :width="width" title="计算公式">
        <yu-xform form-type="search" v-model="searchFormdata" label-width="60px" related-table-name="refTable">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="财报类型" ctype="select" data-code="STD_ZB_FNC_CONFTYP" placeholder="财报类型" name="fncConfTyp"></yu-xform-item>
          </yu-xform-group>
        </yu-xform>
        <yu-xtable ref="refTable" :row-number="true" selection-type="radio" :pageable="true" :data-url="dataUrl" :default-load="true" condition-key="condition" :base-params="baseParams">
          <yu-xtable-column label="项目编号" prop="itemId" width="150px"></yu-xtable-column>
          <yu-xtable-column label="项目名称" prop="itemName" width="150px"></yu-xtable-column>
          <yu-xtable-column label="财报类型" prop="fncConfTyp" width="150px" data-code="STD_ZB_FNC_CONFTYP"></yu-xtable-column>
        </yu-xtable>
