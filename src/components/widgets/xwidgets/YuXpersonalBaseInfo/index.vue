<template>
  <div>
    <yu-xdialog :visible.sync="visiable" :width="width" title="个人客户基本信息">
        ...
        <yu-xtable ref="refTable" :row-number="true" selection-type="radio" :pageable="true" :data-url="dataUrl" :default-load="true" condition-key="condition" :base-params="baseParams">
          ...
          <yu-xtable-column label="证件类型 " prop="certType" width="100" data-code="STD_ZB_CERT_TYP"></yu-xtable-column>
          <yu-xtable-column label="证件号码" prop="certCode" width="100"></yu-xtable-column>
          <yu-xtable-column label="证件到期日期" prop="certEndDt"></yu-xtable-column>
          <yu-xtable-column label="客户类型" prop="cusType" :options="dicOptions.cusTypeOptions"></yu-xtable-column>
          <yu-xtable-column label="出生日期" prop="indivDtOfBirth"></yu-xtable-column>
        </yu-xtable>
...
export default {
  name: 'YuXpersonalBaseInfo',
  componentName: 'YuXpersonalBaseInfo',
  mixins: [popList],
  data: function () {
    return {
