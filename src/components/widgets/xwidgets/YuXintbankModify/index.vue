  ...
  <div>
    <yu-xdialog :visible.sync="visiable" :width="width" title="业务合同">
        ...
        <yu-xtable ref="refTable" :row-number="true" selection-type="radio" :pageable="true" :data-url="dataUrl" :default-load="true" condition-key="condition" :base-params="baseParams">
          ...
          <yu-xtable-column label="同业机构(行)名称" prop="cusName"></yu-xtable-column>
          <yu-xtable-column label="业务类型" prop="bizType" width="100" data-code="STD_ZB_CUS_BIZ_TYPE"></yu-xtable-column>
        </yu-xtable>
...
export default {
  name: 'YuXintbankModify',
  componentName: 'YuXintbankModify',
  mixins: [popList],
  data: function () {
    return {
