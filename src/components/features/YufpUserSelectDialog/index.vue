  ...
  <div>
    ...
    >
      ...
      <el-tabs type="border-card" value="user" @tab-click="TabClick">
        ...
        >
          <yu-form :inline="true" :model="queryFields">
            ...
            <yu-form-item>
              <yu-button type="primary" @click="doQuery">查询</yu-button>
            </yu-form-item>
            <yu-form-item>
          ...
          <el-table
            ...
            v-if="item.key != 'nodeUser'"
          >
            <el-table-column prop="key" label="编号" align="center">
            </el-table-column>
          ...
          <el-table
            ...
            v-if="item.key == 'nodeUser'"
          >
            <el-table-column prop="key" label="方法名" align="center">
            </el-table-column>
            <el-table-column prop="value" label="描述" align="center">
            </el-table-column>
          </el-table>
        </el-tab-pane>
        <el-pagination
      ...
      <div align="center" style="margin-top: 20px" class="dialog-footer">
        <el-button type="primary" @click="dialogClose">选取返回</el-button>
      </div>
    </el-dialog-x>
  </div>
</template>
...
export default {
  ...
  data: function () {
    return {
      ...
      selectedVal: "",
      dialogVisible: false,
      dialogTitle: "节点处理对象选择(双击列表项进行选择)",
      selectInfos: [],
      selectedOpts: [],
      urls: [
        {
        ...
        },
        {
          label: "项目池",
          key: "pool",
          value: backend.workflowService + "/api/taskpool/",
        },
        {
          label: "自定义",
          key: "nodeUser",
  ...
  methods: {
    ...
    userCheck: function (userInfosT, poolCount, type) {
      ...
      if (poolCount > 0) {
        this.$message({
          message:
            "项目池和其他类型办理人员不能同时配置,且只能配置一个项目池作为办理人员!",
          type: "warning",
          duration: 6000,
        });
        return false;
    ...
    dialogClose: function () {
      ...
      this.$emit("select-fn", "user", selectedId);
