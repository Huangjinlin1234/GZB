...
const frameConfig = {
  ...
  baseFrameOptions: {
    ...
    themesList: [
      ...
      { id: 'zrcbank', color: '#2877FF', name: getI18nMessage('component.skinBlue'), checked: true },
      { id: 'blue', color: '#2877FF', name: getI18nMessage('component.skinBlue') + '（' + getI18nMessage('component.mr') + '）'},
    ...
    // 应用切换列表
    appOptions: [
      // { applicationId: '1', applicationName: '张家港新信贷'},
    ...
    sysTools: [
      ...
      { show: true, text: '签到', icon: 'zrcbk-icon-toubu-qiandao', className: '', id: 'sign', badgeDot: false },
      { show: true, text: '请假', icon: 'zrcbk-icon-toubu-qingjia', className: '', id: 'leave', badgeDot: false },
      { show: true, text: getI18nMessage('component.message'), icon: 'yu-icon-message', className: '', id: 'message', badgeDot: true },
      { show: false, text: getI18nMessage('component.themes'), icon: 'yu-icon-theme', className: '', id: 'themes' },
