<template>
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="1">
          ...
          <yu-xform-item label="集团客户编号" ctype="yu-xgrp-custom" name="grpCusId" rules="required" placeholder="集团客户编号" @select-fn="commonSelectFn" :mapping="{'grpNo':'grpCusId','grpName':'grpCusName'}" width="730" height="480" ></yu-xform-item>
    ...
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button type="primary" @click="customClick('onSave')">下一步</yu-button>
