<template>
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="担保方式" ctype="select" name="guarMode" data-code="STD_ZB_LMT_GUAR_WAY" placeholder="担保方式"></yu-xform-item>
          ...
          <yu-xform-item label="授信金额" ctype="yu-currency" name="lmtAmt" placeholder="授信金额" :min="0" ></yu-xform-item>
          <yu-xform-item label="授信期限" ctype="input" placeholder="授信期限" name="lmtTerm" hidden></yu-xform-item>
          <yu-xform-item label="是否预授信额度" ctype="select" name="isPreLmt" data-code="STD_ZB_YES_NO" placeholder="是否预授信额度"></yu-xform-item>
    ...
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button type="primary" @click="customClick('onNextStep')">下一步</yu-button>
      <yu-button type="primary" @click="customClick('onBack')">取消</yu-button>
    </yu-form-buttons>
  </div>
</template>
<script>
...
export default{
  ...
  data: function () {
    return {
      updateUrl: this.$backend.cmisBiz + '/api/lmtappsub/update',
      addUrl: this.$backend.cmisBiz + '/api/lmtappsub/',
      formdata: {},
      formType: 'edit',
      formRules: { },
      imageUrls: {},
