...
<script>
import d1Billcard from './lmtAppRedicussInfo_d1_BillCard.vue'
import d111Billcard from './lmtAppRedicussInfo_d1_11_BillCard.vue'
/**
* title 单一客户授信再议基本信息
* author 朱滋润
* date 2021-04-02
...
export default {
  ...
  methods:{
    ...
    AfterInit() {
      ...
      if ('VIEW' == this.getFactory().contextData.op) {
      ...
      //d1_BillCard.queryDataByCondition('pk_id = \'' + frameContext.pk_id + '\'');
