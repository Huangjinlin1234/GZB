<template>
  <div>
    ...
    <yu-tabs type="card">
      <yu-tab-pane label="产品授信变更申报">
        <yu-panel title="产品授信变更申请列表" panel-type="simple">
          <yu-xform v-model="searchFormdata" related-table-name="refTable" form-type="search" :remove-empty="true" label-width="120px">
            <yu-xform-group :column="3">
              ...
              <yu-xform-item label="产品类型" ctype="select" placeholder="产品类型" name="lmtBizType" data-code="STD_ZB_PRD_BIZ_TYPE" :datacode-filter="datacodeFilterFn1"  exclude-key="4009,16010101,16020101,4011,4012" fuzzy-query="both"></yu-xform-item>
              <yu-xform-item label="项目名称" ctype="input" placeholder="项目名称" name="proName" fuzzy-query="both" maxlength="200"></yu-xform-item>
              <yu-xform-item label="申请类型" ctype="select" name="appType" placeholder="申请类型" data-code="STD_SX_LMT_TYPE" exclude-key="01,04,06,07,08" fuzzy-query="both"></yu-xform-item>
      ...
      <yu-tab-pane label="产品授信变更申报历史">
        <yu-panel title="产品授信变更申请历史列表" panel-type="simple">
    ...
    <yu-xdialog title="额度申请向导" :visible.sync="show_dialog" width="800px" height="400px">
      <yu-xform label-width="120px" ref="addForm" :form-type="formType" v-model="formdata">
        ...
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="业务类型" ctype="select" placeholder="业务类型" name="lmtBizType" data-code="STD_ZB_PRD_BIZ_TYPE" rules="required" disabled></yu-xform-item>
...
export default {
  ...
  data () {
    return {
      ...
      dataUrl1: this.$backend.cmisBiz + '/api/lmtsiginvestapp/selectByModelProductCha',
      Param1: {
      ...
      dataUrl2: this.$backend.cmisBiz + '/api/lmtsiginvestapp/selectByModelProductChaHis',
      Param2: {
        condition: JSON.stringify({
          listtype: '02',
          oprType: '01',
  ...
  methods: {
    ...
    doNextStepForAdd () {
      let _this = this;
      _this.btnLoginLoading = true;
      requestData('/api/lmtsiginvestapp/oninvestchange');
