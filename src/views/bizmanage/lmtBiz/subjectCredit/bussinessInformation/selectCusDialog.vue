<template>
  <div>
    <yu-tabs type="card" v-model="activeName">
      ...
      <yu-tab-pane label="企业法人" name="first">
        <yu-panel title="业务合同" panel-type="simple">
          <yu-xform form-type="search" ref="refForm1" v-model="bussinessSearchFormdata" label-width="120px" related-table-name="refTable1">
          ...
          <yu-button style="margin-bottom:10px;" icon="check" type="primary" @click="backToAdd">选取返回</yu-button>
          <yu-xtable ref="refTable1" :row-number="true" selection-type="radio" :pageable="true" :data-url="bussinessDataUrl" :default-load="true" condition-key="condition" :base-params="bussinessParams" request-type="post">
      ...
      <yu-tab-pane label="个人客户" name="second">
        <yu-panel title="个人客户信息" panel-type="simple">
          <yu-xform ref="refForm" form-type="search" v-model="searchIndivFormdata" label-width="120px" related-table-name="refIndivTable">
          ...
          <yu-button style="margin-bottom:10px;" icon="check" type="primary" @click="backToAdd">选取返回</yu-button>
          <yu-xtable ref="refIndivTable" :row-number="true" selection-type="radio" :pageable="true" :data-url="indivDataUrl" :default-load="true" condition-key="condition" :base-params="baseParams" request-type="post">
            <yu-xtable-column label="客户编号" prop="cusId"></yu-xtable-column>
            <yu-xtable-column label="客户名称" prop="cusName"></yu-xtable-column>
            <yu-xtable-column label="证件类型 " prop="certType" data-code="STD_ZB_CERT_TYP"></yu-xtable-column>
            <yu-xtable-column label="证件号码" prop="certCode" ></yu-xtable-column>
      ...
      <yu-tab-pane label="同业客户" v-if="show==3" name="third">
...
export default {
  ...
  data () {
    return {
      ...
      baseParams: {},
      bussinessDataUrl: backend.cmisCus + '/api/cusbase/baseCrop',
      bussinessParams: { condition: {cusCatalog: '2'} },
      indivDataUrl: backend.cmisCus + '/api/cusindiv/queryCusIndiv',
      activeName: 'first',
      show: '',
      replySearchFormdata: {},
  ...
  methods: {
    ...
    backToAdd () {
      ...
      if (this.activeName == 'first') {
        ...
        selection = _this.$refs.refIndivTable.selections;
        selectData(selection, '1', '01');
