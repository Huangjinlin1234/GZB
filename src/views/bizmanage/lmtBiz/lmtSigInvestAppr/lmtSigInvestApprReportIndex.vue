  ...
  <div class="tab-form">
    <yu-panel title="主体授信申报审批" panel-type="simple">
      <yu-tabs type="card">
        ...
        <yu-tab-pane label="审查报告">
          <lmtSigInvestApprReport :pageParams="pageParams"></lmtSigInvestApprReport>
        </yu-tab-pane>
      </yu-tabs>
    </yu-panel>
  </div>
...
<script>
import lmtSigInvestApprReport from "./lmtSigInvestApprReport";
import subjectCreditDetails from "../subjectCredit/subjectCreditDetails";
export default {
  components: { lmtSigInvestApprReport, subjectCreditDetails },
  props: {
    bizPageData: {
      type: Object,
      default: function () {
