<template>
  <div>
    <yu-panel title="主体业务授信批复查询" panel-type="simple">
      ...
      <yu-panel title="主体业务授信批复查询列表" panel-type="simple">
        <yu-button-drop>
        ...
        <yu-xtable ref="refTable" condition-key="condition" selection-type="radio" row-number requestType="POST"
