<template>
  <div id="d1_A_14_BillCard">
    <div id="d1_A_14_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-panel title="授信品种信息">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="授信品种名称" ctype="input" placeholder="授信品种名称" name="bizTypeName" rules="required" disabled :colspan="12"></yu-xform-item>
            ...
            <yu-xform-item label="授信额度" ctype="input" placeholder="授信额度" name="lmtAmt" rules="required" :colspan="12"></yu-xform-item>
            ...
            <yu-xform-item label="保证金预留比例" ctype="input" placeholder="保证金预留比例" name="bailPreRate" disabled hidden :colspan="12"></yu-xform-item>
            <yu-xform-item label="额度期限" ctype="input" placeholder="额度期限" name="lmtTerm" rules="required" :colspan="12"></yu-xform-item>
            <yu-xform-item label="宽限期" ctype="input" placeholder="宽限期" name="graper" hidden :colspan="12"></yu-xform-item>
            ...
            <yu-xform-item label="还款方式" ctype="select" name="repayMode" hidden data-code="STD_ZB_REPAY_MODE" placeholder="还款方式" :colspan="12"></yu-xform-item>
            <yu-xform-item label="结息方式" ctype="select" name="eiMode" hidden placeholder="结息方式" :colspan="12"></yu-xform-item>
            ...
            <yu-xform-item label="手续费率" ctype="input" placeholder="手续费率" name="chrgRate" hidden :colspan="12"></yu-xform-item>
            <yu-xform-item label="手续费收取方式" ctype="select" name="chrgCollectMode" hidden placeholder="手续费收取方式" :colspan="12"></yu-xform-item>
            <yu-xform-item label="是否预授信额度" ctype="input" placeholder="是否预授信额度" name="isPreLmt" rules="required" disabled :colspan="12"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
        <yu-panel title="委托人信息">
          <yu-xform-group :column="2">
            <yu-xform-item label="委托人名称" ctype="input" placeholder="委托人名称" name="consignorName" hidden :colspan="12"></yu-xform-item>
            <yu-xform-item label="委托人类型" ctype="input" placeholder="委托人类型" name="consignorType" hidden :colspan="12"></yu-xform-item>
            <yu-xform-item label="委托人证件类型" ctype="input" placeholder="委托人证件类型" name="consignorCertType" disabled hidden :colspan="12"></yu-xform-item>
            <yu-xform-item label="委托人证件号码" ctype="input" placeholder="委托人证件号码" name="consignorCertId" disabled hidden :colspan="12"></yu-xform-item>
            <yu-xform-item label="委托人客户号" ctype="input" placeholder="委托人客户号" name="consignorCusId" disabled hidden :colspan="12"></yu-xform-item>
            <yu-xform-item label="还款计划描述" ctype="input" placeholder="还款计划描述" name="repayPlanDesc" hidden :colspan="12"></yu-xform-item>
