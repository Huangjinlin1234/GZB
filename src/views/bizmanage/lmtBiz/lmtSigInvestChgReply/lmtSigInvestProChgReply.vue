<template>
  ...
  <div class="tab-form">
    <yu-tabs v-model="tabName">
      <yu-tab-pane label="产品授信批复变更申请" name="base">
        <yu-panel title="输入查询条件" panel-type="simple">
          ...
          <yu-panel title="产品授信批复变更申请列表" panel-type="simple">
        ...
        <yu-xdialog title="批复变更新增向导" :visible.sync="dialogVisibleadd" width="600px">
          <yu-xform ref="refForm" label-width="100px" v-model="formdata2" :disabled="formDisabled">
            <yu-xform-group :column="1">
              <yu-xform-item label="批复编号" name="replySerno" ctype="input" icon="search" @click="selectFn" disabled rules="required"></yu-xform-item>
      ...
      <yu-tab-pane label="产品授信批复变更历史" name="ReplyHistory">
        <yu-panel title="产品授信批复变更历史" panel-type="simple">
...
export default {
  ...
  methods: {
    ...
    nextFn: function () {
      ...
      yufp.clone(_this.sessionData, _this.formdata2);
      // let obj = Object.assign(_this.sessionData, _this.formdata2);
