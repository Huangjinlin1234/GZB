...
<script>
import d1Billlist from './coopOperateViewPlanAppHist_d1_BillList.vue';
export default {
  ...
  methods: {
    ...
    AfterInit () {
      ...
      // this.d1_BillList.setAppendSQLCondition({partnerNo:this.getFactory().contextData.cusId});
    ...
    doView () {
      ...
      jsoPar['op'] = 'details';
      this.$route.meta.params = jsoPar;
      this.$dialog.open(
        '楼盘项目信息',
        'bizmanage/coopBiz/coopPlanApp/cooPlanAppInfo',
        -1,
        -1,
        jsoPar
      );
