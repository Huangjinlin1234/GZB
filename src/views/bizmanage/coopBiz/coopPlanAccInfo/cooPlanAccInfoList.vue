<template>
  <div>
    <yu-panel title="合作方案台账" panel-type="simple">
      ...
      <template>
        ...
        <yu-button type="primary" ref="btn_batchPrint" v-if="checkCtrl('export')" @click="customClick('batchPrint')">查看批复报告</yu-button>
      </template>
      <yu-xtable ref="refTable" row-number condition-key="condition" request-type="post" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :base-params="baseParams" :pageable="true" :data-url="dataUrl" :default-load="true">
...
yufp.lookup.reg('STD_PARTNER_TYPE,STD_COOP_PLAN_OPR_TYPE,STD_ZB_APPR_STATUS,STD_COOP_PRO_STATUS');
export default {
  name: 'D1BillList',
