  ...
  <div class="org-list">
    <yu-panel :collapse-hide="false">
      ...
      <yu-panel ref="panel" title="" color="red" class="adjust-height" :collapse-hide="false">
        <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="checkbox" request-type="post" :pageable="false" :data-url="dataUrl" :default-load="false" :base-params="baseParams">
