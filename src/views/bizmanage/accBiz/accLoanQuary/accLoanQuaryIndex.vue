...
<template>
  ...
  <div>
      ...
      <template slot="filter">
        <yu-xform related-table-name="refTable" ref="searchForm" v-model="searchFormdata" label-width="120px">
          <yu-xform-group :column="1">
            ...
            <yu-xform-item label="十级分类" placeholder="十级分类" ctype="checkbox" value-type="string" name="tenClassList" data-code="STD_TEN_CLASS"></yu-xform-item>
          </yu-xform-group>
        </yu-xform>
    ...
    <yu-panel title="对公贷款实时报表" :hideFilter="false" :collapseHide="false">
      <yu-button-drop>
...
export default {
  ...
  data: function () {
    return {
      baseParams: {condition: { oprType: '01', belgLineList: '03,04' }},
      searchFormdata: {},
      visiable: false,
      dataUrl: this.$backend.cmisBiz + '/api/accloan/',
      excelExportUrl: backend.cmisBiz + '/api/accloan/exportaccloan',
