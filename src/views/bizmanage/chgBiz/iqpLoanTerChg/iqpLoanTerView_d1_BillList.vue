  ...
  <div>
    <yu-panel title="贷款投向调整列表">
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="baseParams" :default-load="false">
        ...
        <yu-xtable-column label="客户名称" prop="cusName" width="70"></yu-xtable-column>
        <yu-xtable-column label="产品编号" prop="prdId" width="70"></yu-xtable-column>
        <yu-xtable-column label="产品名称" prop="prdName" width="70"></yu-xtable-column>
        ...
        <yu-xtable-column label="申请状态" prop="approveStatus" width="70" data-code="STD_ZB_APPR_STATUS"></yu-xtable-column>
      </yu-xtable>
    </yu-panel>
  </div>
</template>
