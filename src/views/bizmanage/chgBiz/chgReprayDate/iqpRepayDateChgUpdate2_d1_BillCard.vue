<template>
  <div id="d1_BillCard">
      ...
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-panel title="借据基本信息">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="起始日期" ctype="datepicker" name="distrDate" value-format="yyyy-MM-dd" disabled placeholder="起始日期"></yu-xform-item>
        ...
        <yu-panel title="原还款方式信息">
          <yu-xform-group :column="3">
            <yu-xform-item label="还款方式" ctype="select" name="oldRepayMode" disabled data-code="STD_ZB_REPAY_TYP" placeholder="还款方式"></yu-xform-item>
            <yu-xform-item label="原停本付息期间" ctype="select" name="oldStopPintTerm" disabled hidden data-code="STD_ZB_PINT_TERM" placeholder="原停本付息期间"></yu-xform-item>
            ...
            <yu-xform-item label="还款日" ctype="datepicker" name="oldRepayDate" value-format="yyyy-MM-dd" disabled placeholder="还款日"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
        <yu-panel title="调整后的还款方式信息">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="还款日" ctype="yu-num" name="repayDate" rules="required" placeholder="还款日" :precision="0" :min="0" ></yu-xform-item>
        ...
        <yu-panel title="登记信息">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="主办人" ctype="yu-xuser" name="managerId" rules="required" hidden placeholder="主办人" @select-fn="commonSelectFn" :mapping="{'orgName':'managerBrName','loginCode':'managerId','userName':'managerName','orgId':'managerBrId'}" width="720" height="480" ></yu-xform-item>
            <yu-xform-item label="主办机构" ctype="yu-xuser" name="managerBrId" rules="required" hidden placeholder="主办机构" @select-fn="commonSelectFn" :mapping="{'orgName':'managerBrName','loginCode':'managerId','userName':'managerName','orgId':'managerBrId'}" width="720" height="480" ></yu-xform-item>
    ...
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      ...
      <yu-button type="primary" @click="customClick('onSubmit')">提交</yu-button>
...
export default{
  ...
  methods: {
    execBillCardDefaultValueFormula:function() {
      this.formdata.iqpSerno = this.$xutils.getDefaultformulaData("SEQ:{IQP_REPAY_SERNO}")
