  ...
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="用信期限">
          <yu-xform-group :column="3">
            <yu-xform-item label="授信协议编号" ctype="yu-xcredit-proto2" name="lmtCtrNo" rules="required" disabled placeholder="授信协议编号" @select-fn="commonSelectFn" :mapping="{'lmtCtrNo':'lmtCtrNo'}" width="720" height="480" ></yu-xform-item>
            <yu-xform-item label="授信额度" ctype="yu-currency" name="lmtAmt" rules="required" disabled placeholder="授信额度" :min="0" ></yu-xform-item>
            ...
            <yu-xform-item label="授信到期日期" ctype="input" placeholder="授信到期日期" name="lmtEndDate" rules="required" disabled></yu-xform-item>
            <yu-xform-item label="授信审批通知书有效期" ctype="input" placeholder="授信审批通知书有效期" name="lmtDocIdate" rules="required"></yu-xform-item>
            <yu-xform-item label="调整后的授信审批通知书有效期" ctype="input" placeholder="调整后的授信审批通知书有效期" name="adjustIdate" rules="required"></yu-xform-item>
