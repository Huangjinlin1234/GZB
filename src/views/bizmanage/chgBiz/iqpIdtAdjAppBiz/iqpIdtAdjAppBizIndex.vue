...
<script>
import d1Billlist from './iqpIdtAdjAppBiz_d1_BillList.vue'
/**
 * 业务变更/授信审批通知书有效期/列表页面
 */
let reyPlanList;
...
export default {
  ...
  methods:{
    ...
    addFn() {
      this.$dialog.open(
        '授信审批通知书有效期新增',
        'bizmanage/chgBiz/iqpIdtAdjAppBiz/iqpIdtAdjAppAddIndex',
        '900',
        '600',
        null,
        null
    ...
    editFn() {
      ...
      selectedRowData['model_group_no'] = 'CMG000077';//额度申请模板
