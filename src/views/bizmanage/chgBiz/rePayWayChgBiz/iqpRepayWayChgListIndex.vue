<template>
  <div>
    <yu-panel title="还款方式变更申请列表" panel-type="normal">
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" :pageable="true" :data-url="dataUrl" :base-params="baseParams" :default-load="true">
        ...
        <yu-xtable-column label="原还款方式" prop="oldRepayMode" data-code="STD_ZB_REPAY_TYP"></yu-xtable-column>
        <yu-xtable-column label="还款方式" prop="repayMode" data-code="STD_ZB_REPAY_TYP"></yu-xtable-column>
...
export default {
  ...
  data () {
    return {
      ...
      deleteUrl: this.$backend.cmisBiz + '/api/iqprepaywaychg/delete/'
    };
  },
  mounted () {
  ...
  methods: {
    ...
    onInsert () {
      this.$dialog.open(
        '还款方式变更申请',
        'bizmanage/chgBiz/rePayWayChgBiz/iqpRepayWayChgAddIndex',
        400,
        200,
        {},
    ...
    doUpdate () {
      ...
      jsoPar['model_group_no'] = 'CMG000033';
      jsoPar['op'] = 'EDIT';
