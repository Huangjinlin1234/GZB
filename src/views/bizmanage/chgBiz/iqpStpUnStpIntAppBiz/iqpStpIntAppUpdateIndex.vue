      ...
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :disabled="formDisabled">
        <yu-panel title="申请信息">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="停息日期" ctype="datepicker" name="stopDate" value-format="yyyy-MM-dd" rules="required" placeholder="停息日期"></yu-xform-item>
            <yu-xform-item label="停息原因" ctype="textarea" name="resn" rules="required" placeholder="停息原因"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
        <yu-panel title="登记信息">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="恢复计息日期" ctype="datepicker" name="unstopDate" value-format="yyyy-MM-dd" hidden placeholder="恢复计息日期"></yu-xform-item>
            <yu-xform-item label="表外欠息" ctype="yu-currency" name="outOweInt" hidden placeholder="表外欠息" :min="0" ></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
      </yu-xform>
    </div>
...
<script>
yufp.lookup.reg('STD_ZB_OPR_TYPE,STD_ZB_APPR_STATUS,STD_ZB_CUR_TYP,STD_ZB_INT_TYPE,STD_ZB_YES_NO');
/**
 * title 停息新增修改界面
 * author 马顺
 * date 2021-01-13
...
export default {
  ...
  methods: {
    ...
    tempSave () {
      ...
      const rtnData = this.tempUpdatedData();
