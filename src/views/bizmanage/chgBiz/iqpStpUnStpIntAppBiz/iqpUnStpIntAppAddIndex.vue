...
export default {
  ...
  created: function () {
    this.baseParams = {condition: {'managerId': '${LoginLoginCode}', 'accStatus': '1'}};
  },
  mounted () {
  },
  methods: {
    ...
    doNextStep () {
      ...
      this.$xutils.request({
        // 同步请求
        async: false,
        url: this.$backend.cmisBiz + '/api/iqpstpunstpintapp/saveIqpUnStpIntAppLeadInfo/' + billNo,
      ...
      this.$xutils.showMsgBox('提示', '新增成功', null, null, () => {
        ...
        params['model_group_no'] = 'CMG000048';// 恢复计息申请模板组
