<template>
 ...
 <yu-panel title="" :hideFilter="true" :collapseHide="true">
    <yu-xform ref="form" label-width="150px" v-model="form" :form-type="formType">
      <yu-xform-group>
          <yu-xform-item placeholder="勘验流水号" label="勘验流水号" ctype="input" name="inspectSerno" disabled v-if="show"></yu-xform-item>
          ...
          <yu-xform-item placeholder="云评估编号" label="云评估编号" ctype="input" name="cloudEvalNo" icon="search" :on-icon-click="openDialog"   rules="required"></yu-xform-item>
          <yu-xform-item placeholder="小区名称" label="小区名称" ctype="input" name="buildingName" disabled></yu-xform-item>
          <yu-xform-item placeholder="楼栋" label="楼栋" ctype="input"  name="building" disabled></yu-xform-item>
          <yu-xform-item placeholder="面积(㎡)" label="面积(㎡)" ctype="input" name="squ" disabled></yu-xform-item>
          <yu-xform-item placeholder="勘验状态" label="勘验状态" ctype="input" name="oprType" disabled v-if="show"></yu-xform-item>
          <yu-xform-item placeholder="操作类型" label="操作类型" ctype="input" name="inspectStatus" disabled v-if="show"></yu-xform-item>
          <yu-xform-item placeholder="地址" label="地址" ctype="input" name="addr" disabled></yu-xform-item>
          <yu-xform-item placeholder="所有人" label="所有人" ctype="input" name="pawnOwner"></yu-xform-item>
...
lookup.reg('STD_ZB_YES_NO,STD_ZB_CERT_TYP');
export default {
  // name: "standardForm",
  data: function () {
    return {
