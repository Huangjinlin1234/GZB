<template>
   ...
   <yu-tabs v-model="activeName">
    ...
    <yu-panel  panel-type="normal">
      ...
      <template slot="right">
        <yu-button-drop>
          <yu-button  @click="onInsert">新增</yu-button>
          <yu-button  @click="onUpdate(true)">修改</yu-button>
          <yu-button @click="onDelete">删除</yu-button>
          <yu-button  @click="onUpdate(false)">查看</yu-button>
        </yu-button-drop>
      </template>
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" :pageable="true" :data-url="dataUrl" :base-params="{'condition':{'apply': 'Y'}}" :default-load="true" request-type="post">
    ...
    <yu-panel  panel-type="normal">
      ...
      <yu-xtable ref="refTableOld" row-number condition-key="condition" selection-type="radio" :pageable="true" :data-url="dataUrl" :base-params="{'condition':{'history':'Y'}}" :default-load="true" request-type="post">
        <yu-xtable-column label="业务流水号" prop="iqpSerno"></yu-xtable-column>
        <yu-xtable-column label="借据编号" prop="billNo"></yu-xtable-column>
        <yu-xtable-column label="合同编号" prop="contNo" width="120"></yu-xtable-column>
        <yu-xtable-column label="客户编号" prop="cusId"></yu-xtable-column>
