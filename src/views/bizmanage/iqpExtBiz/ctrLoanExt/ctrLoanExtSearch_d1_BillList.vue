    ...
    <yu-panel title="">
      ...
      <template slot="right">
        <yu-button-drop>
          ...
          <yu-button ref="btn_doRevoke" @click="customClick('doRevoke')">撤销</yu-button>
          <yu-button ref="btn_doPrint" @click="customClick('doPrint')">打印</yu-button>
        </yu-button-drop>
      </template>
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="{'a.extCtrStatus !':'001'}" :default-load="true">
        <yu-xtable-column label="业务流水号" prop="extSerno"></yu-xtable-column>
