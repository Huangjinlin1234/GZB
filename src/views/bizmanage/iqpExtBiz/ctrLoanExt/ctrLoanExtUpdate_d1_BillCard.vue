    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="展期协议号" ctype="input" placeholder="展期协议号" name="extCtrNo" rules="required" hidden></yu-xform-item>
        ...
        <yu-panel title="展期信息">
          <yu-xform-group :column="3">
            <yu-xform-item label="展期申请流水号" ctype="input" placeholder="展期申请流水号" name="tmpAppSerno" rules="required" disabled></yu-xform-item>
            <yu-xform-item label="展期协议编号" ctype="input" placeholder="展期协议编号" name="extCtrNoTemp" rules="required" disabled></yu-xform-item>
            <yu-xform-item label="展期金额" ctype="yu-currency" name="extAmt" rules="required" disabled placeholder="展期金额" :min="0" ></yu-xform-item>
            <yu-xform-item label="申请日期" ctype="datepicker" name="extAppDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd" rules="required" disabled hidden placeholder="申请日期"></yu-xform-item>
            <yu-xform-item label="展期期限类型" ctype="select" name="extTermType" rules="required" hidden data-code="STD_ZB_TERM_TYP" placeholder="展期期限类型"></yu-xform-item>
            <yu-xform-item label="期限" ctype="yu-num" name="term" rules="required" hidden placeholder="期限" :precision="0" :min="0" ></yu-xform-item>
            <yu-xform-item label="展期到期日期" ctype="datepicker" name="extEndDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd" rules="required" disabled placeholder="展期到期日期"></yu-xform-item>
            <yu-xform-item label="展期协议签订日期" ctype="datepicker" name="signDate" value-format="yyyy-MM-dd" rules="required" disabled placeholder="展期协议签订日期"></yu-xform-item>
            <yu-xform-item label="备注" ctype="textarea" name="remark" placeholder="备注"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
        <yu-panel title="利率定价信息">
          <yu-xform-group :column="3">
            <yu-xform-item label="利率依据方式" ctype="select" name="irAccordType" rules="required" disabled data-code="STD_ZB_IR_WAY" placeholder="利率依据方式"></yu-xform-item>
            ...
            <yu-xform-item label="基准利率（年）" ctype="yu-interest-rate" name="rulingIr" rules="required" disabled placeholder="基准利率（年）"></yu-xform-item>
            <yu-xform-item label="对应基准利率(月)" ctype="yu-num" name="rulingIrM" rules="required" disabled placeholder="对应基准利率(月)" sign="‰" :multiple="1000" :precision="9" ></yu-xform-item>
            <yu-xform-item label="利率形式" ctype="select" name="rateType" rules="required" disabled data-code="STD_ZB_RATE_TYPE" placeholder="利率形式"></yu-xform-item>
            <yu-xform-item label="利率调整方式" ctype="select" name="irAdjustType" rules="required" disabled data-code="STD_ZB_RADJ_TYP" placeholder="利率调整方式"></yu-xform-item>
            <yu-xform-item label="利率调整周期(月)" ctype="yu-num" name="irAdjustTerm" rules="required" disabled placeholder="利率调整周期(月)" :precision="0" :min="0" ></yu-xform-item>
            <yu-xform-item label="利率浮动方式" ctype="select" name="irFloatType" rules="required" disabled data-code="STD_ZB_RFLOAT_TYP" placeholder="利率浮动方式"></yu-xform-item>
            ...
            <yu-xform-item label="计息方式" ctype="select" name="loanRatType" rules="required" disabled data-code="STD_ZB_LOAN_RAT_TYPE" placeholder="计息方式"></yu-xform-item>
            ...
            <yu-xform-item label="展期执行利率（年）" ctype="yu-interest-rate" name="extRealityIrY" rules="required" disabled placeholder="展期执行利率（年）"></yu-xform-item>
            <yu-xform-item label="展期执行利率(月)" ctype="yu-num" name="extRealityIrM" rules="required" disabled placeholder="展期执行利率(月)" sign="‰" :multiple="1000" :precision="9" ></yu-xform-item>
            <yu-xform-item label="逾期利率浮动方式" ctype="select" name="overdueFloatType" rules="required" disabled data-code="STD_ZB_RFLOAT_TYP" placeholder="逾期利率浮动方式"></yu-xform-item>
            ...
            <yu-xform-item label="逾期利率加点值" ctype="yu-num" name="overduePoint" rules="required" disabled placeholder="逾期利率加点值" :multiple="10000" sign="‱" ></yu-xform-item>
            <yu-xform-item label="逾期利率（年）" ctype="yu-interest-rate" name="overdueRateY" rules="required" disabled placeholder="逾期利率（年）"></yu-xform-item>
            <yu-xform-item label="违约利率浮动方式" ctype="select" name="defaultFloatType" rules="required" disabled data-code="STD_ZB_RFLOAT_TYP" placeholder="违约利率浮动方式"></yu-xform-item>
            ...
            <yu-xform-item label="违约利率加点值" ctype="yu-num" name="defaultPoint" rules="required" disabled placeholder="违约利率加点值" :multiple="10000" sign="‱" ></yu-xform-item>
            <yu-xform-item label="违约利率（年）" ctype="yu-interest-rate" name="defaultRateY" rules="required" disabled placeholder="违约利率（年）"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
        <yu-panel title="合同补充要素">
          <yu-xform-group :column="3">
            <yu-xform-item label="合同份数" ctype="input" placeholder="合同份数" name="contQnt" rules="required"></yu-xform-item>
            <yu-xform-item label="甲方执合同份数" ctype="input" placeholder="甲方执合同份数" name="contQntOwner" rules="required"></yu-xform-item>
            <yu-xform-item label="乙方执合同份数" ctype="input" placeholder="乙方执合同份数" name="contQntPartyB" rules="required"></yu-xform-item>
            <yu-xform-item label="丙方执合同份数" ctype="input" placeholder="丙方执合同份数" name="contQntPartyC" rules="required"></yu-xform-item>
            <yu-xform-item label="其他约定事项" ctype="textarea" name="otherAgreedEvent" placeholder="其他约定事项"></yu-xform-item>
        ...
        <yu-panel title="登记信息">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="展期协议状态" ctype="select" name="extCtrStatus" data-code="STD_ZB_CTR_ST" placeholder="展期协议状态"></yu-xform-item>
            <yu-xform-item label="撤销日期" ctype="datepicker" name="logoutDate" value-format="yyyy-MM-dd" hidden placeholder="撤销日期"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
      </yu-xform>
    </div>
...
export default{
  ...
  data: function () {
    return {
      updateUrl: this.$backend.cmisBiz + "/api/ctrloanext/update",
      addUrl: this.$backend.cmisBiz + "/api/ctrloanext/",
      formdata : {},
      formType : 'edit',
      formRules: { },
      imageUrls:{},
  ...
  methods: {
    execBillCardDefaultValueFormula:function() {
      ...
      this.formdata.signDate = this.$xutils.getDefaultformulaData("$CURRDATE")
