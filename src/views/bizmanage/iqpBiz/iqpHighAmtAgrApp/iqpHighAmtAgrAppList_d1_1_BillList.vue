<template>
  <div>
    <yu-panel title="最高额授信协议申请" :hideFilter="false" :collapseHide="false">
      <yu-xform ref="refForm" form-type="search" v-model="searchFormdata" label-width="120px" :custom-search-fn="customSearch">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="担保方式" ctype="select" data-code="STD_ZB_GUAR_WAY" placeholder="担保方式" name="guarMode"></yu-xform-item>
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="{'oprType':'01'}" :default-load="true" request-type="POST">
        ...
        <yu-xtable-column label="协议币种" prop="agrType" data-code="STD_ZB_CUR_TYP"></yu-xtable-column>
        <yu-xtable-column label="协议金额" prop="agrAmt" :formatter="formatNumber('0,000.00',2)"></yu-xtable-column>
...
<script>
yufp.lookup.reg('STD_ZB_APPR_STATUS,STD_ZB_YES_NO,STD_CONT_TYPE,STD_ZB_CUR_TYP,STD_ZB_GUAR_WAY');
...
export default {
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/iqphighamtagrapp/tosignlist',
      baseParams: {},
      deleteUrl: this.$backend.cmisBiz + '/api/iqphighamtagrapp/delete/'
    };
  },
  methods: {
    // 字典项过滤
