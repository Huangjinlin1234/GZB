<template>
  <d1-billcard ref="d1_BillCard" :base-params="baseParams"></d1-billcard>
</template>
<script>
import d1Billcard from './iqpDiscAppPordSubAdd_d1_BillCard.vue';
let selfPar = {};
...
export default {
  ...
  methods: {
    AfterInit () {
      ...
      this.d1_BillCard.execBillCardDefaultValueFormula(); // 执行默认值公式
    },
    ...
    doSave () {
      ...
      this.d1_BillCard.setItemValue('serno', selfPar.biz_serno); // 流水号
      ...
      this.$xutils.request({
        ...
        url: this.$backend.cmisBiz + '/api/iqpdiscapppordersub/saveidapordersubinfo',
