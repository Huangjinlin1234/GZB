<template>
  <div>
    <yu-panel title="贴现协议申请历史" :hideFilter="false" :collapseHide="false">
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="{ oprType: '01' }" :default-load="true" request-type="POST">
        ...
        <yu-xtable-column label="贴现协议金额" prop="contAmt" :formatter="formatNumber('0,000.00',2)"></yu-xtable-column>
...
export default {
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/iqpdiscapp/donesignlist',
      baseParams: {},
