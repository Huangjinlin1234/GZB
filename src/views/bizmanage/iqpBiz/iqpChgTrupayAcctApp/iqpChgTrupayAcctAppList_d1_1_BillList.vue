<template>
  <div>
    <yu-panel title="修改受托账号申请列表" :hideFilter="false" :collapseHide="false">
      <yu-xform ref="refForm" form-type="search" v-model="searchFormdata" label-width="120px" :custom-search-fn="customSearch">
        <yu-xform-group :column="4">
          <yu-xform-item label="核心流水号" ctype="input" placeholder="核心流水号" name="hxSerno"></yu-xform-item>
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="{'approveStatus':'000 or approveStatus'}" :default-load="true" request-type="POST">
        <!--<yu-xtable-column label="核心流水号" prop="hxSerno" width="100"></yu-xtable-column>-->
...
export default{
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/iqpchgtrupayacctapp/tosignlist',
      baseParams: {},
