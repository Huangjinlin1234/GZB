    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="3">
          <yu-xform-item label="保证金账号" ctype="yu-xbail-info" name="bailAccNo" placeholder="保证金账号" @select-fn="commonSelectFn" :mapping="{'bailAccNo':'bailAccNo','accobName':'accobName','bailAccNoSub':'bailAccNoSub','bailCurType':'bailCurType'}" width="730" height="480" ></yu-xform-item>
          <yu-xform-item label="保证金币种" ctype="select" name="bailCurType" data-code="STD_ZX_CUR_TYPE" placeholder="保证金币种"></yu-xform-item>
          <yu-xform-item label="保证金账号子序号" ctype="input" placeholder="保证金账号子序号" name="bailAccNoSub"></yu-xform-item>
          <yu-xform-item label="开户行名称" ctype="input" placeholder="开户行名称" name="accobName"></yu-xform-item>
          <yu-xform-item label="保证金计息方式" ctype="select" name="bailInterestMode" placeholder="保证金计息方式"></yu-xform-item>
          ...
          <yu-xform-item label="保证金金额" ctype="input" placeholder="保证金金额" name="bailAmt" hidden></yu-xform-item>
...
export default{
  ...
  data: function () {
    return {
      updateUrl: this.$backend.cmisBiz + '/api/bailaccinfo/update',
      addUrl: this.$backend.cmisBiz + '/api/bailaccinfo/',
      formdata: {},
      formType: 'edit',
      formRules: { },
      imageUrls: {},
