<template>
  <div class="iqpCvrgAppList_d1_1_BillList">
    <yu-panel title="保函合同申请" :hideFilter="false" :collapseHide="false">
...
export default {
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/iqpcvrgapp/tosignlist',
      baseParams: {},
