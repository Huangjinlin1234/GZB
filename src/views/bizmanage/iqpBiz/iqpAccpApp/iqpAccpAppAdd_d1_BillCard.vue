    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="1">
          ...
          <yu-xform-item label="产品编号" ctype="yu-dg-prd-pop" name="prdId" rules="required" placeholder="产品编号" @select-fn="commonSelectFn" :mapping="{'prdId':'prdId','prdName':'prdName','suitGuarMode':'suitGuarMode'}" :param="{'prdType':'05'}" ></yu-xform-item>
          ...
          <!--<yu-xform-item label="担保方式" ctype="select" name="guarMode" rules="required" data-code="STD_ZB_GUAR_WAY" placeholder="担保方式" @change="isLowRisk"></yu-xform-item>-->
          <yu-xform-item label="担保方式" ctype="select" name="guarMode"  rules="required" :options="guarWayOpt"  placeholder="担保方式"  @change="isLowRisk"></yu-xform-item>
...
<script>
// 注册字典项
yufp.lookup.reg('STD_ZB_GUAR_WAY,STD_CONT_TYPE,STD_PRD_TYPE_PROP');
...
export default {
  ...
  methods: {
    ...
    getGuarWay: function () {
      ...
      for (var i = 0; i < list.length; i++) {
        for (var j = 0; j < datacode1.length; j++) {
    ...
    commonDgContSelect () {
      ...
      var data = { cusId: cusId, lmtAccNo: lmtAccNo, busiType: '07'};
    ...
    handleIconClick: function () {
      ...
      let guarMode = _this.formdata.guarMode;
      if (guarMode == null || guarMode == '') {
        _this.$xutils.showMsgBox('提示', '担保方式不能为空!\r\n请重新操作!', 350, 150);
        return;
      }
  ...
  watch: {
    'formdata.lmtAccNo': function (val) {
      if (val) {
        this.customParams = {
          condition: {contStatus: '200', lmtAccNo: val, busiType: '07'}
        };
      }
    }
  }
