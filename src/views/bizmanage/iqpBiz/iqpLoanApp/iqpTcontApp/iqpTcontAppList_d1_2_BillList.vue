<template>
  <div>
    <yu-panel title="贸易融资合同申请历史" :hideFilter="false" :collapseHide="false">
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="{'oprType':'01'}" :default-load="true" request-type="POST">
        ...
        <yu-xtable-column label="主管客户经理" prop="managerId" width="100" hide-column></yu-xtable-column>
        <yu-xtable-column label="责任机构" prop="managerBrId" width="100" hide-column></yu-xtable-column>
        <yu-xtable-column label="主管客户经理" prop="managerIdName" width="100"></yu-xtable-column>
...
<script>
// 注册字典项
yufp.lookup.reg('STD_ZB_CUR_TYP,STD_ZB_GUAR_WAY,STD_CONT_TYPE,STD_PRD_TYPE_PROP');
...
export default{
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/iqploanapp/tcontdonesignlist',
      baseParams: {},
