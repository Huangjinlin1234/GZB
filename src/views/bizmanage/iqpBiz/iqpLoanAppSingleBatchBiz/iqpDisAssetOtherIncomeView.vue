    ...
    <yu-xform ref="refForm" label-width="180px" v-model="formdata">
      <yu-panel title="" :hideFilter="false" :collapseHide="false">
        <yu-xform-group :column="1">
          ...
          <yu-xform-item label="收入来源" name="incomeSour" ctype="select"  data-code="STD_OTHER_INCOME_SOUR" :disabled="isdisabled" ></yu-xform-item>
          ...
          <yu-xform-item label="调查核实情况说明" ctype="textarea" name="indgtExpl" :rows="3" :colspan="16" placeholder="2000个字符以内" :disabled="isdisabled" ></yu-xform-item>
        </yu-xform-group>
      </yu-panel>
    </yu-xform>
