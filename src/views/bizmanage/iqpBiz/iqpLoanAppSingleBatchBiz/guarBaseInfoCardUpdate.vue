    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="200px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="抵质押品编号" ctype="input" placeholder="抵质押品编号" name="guarNo" disabled></yu-xform-item>
          ...
          <yu-xform-item label="评估价(元）" ctype="input" placeholder="评估价(元）" name="evalAmt" ></yu-xform-item>
          <yu-xform-item label="我行可用价值" ctype="input" name="maxMortagageAmt"  placeholder="我行可用价值" :disabled="isEdit" @change="debounce()"></yu-xform-item>
          <yu-xform-item label="抵/质押率（%）" ctype="yu-num" name="mortagageRate" placeholder="抵/质押率（%）" sign="%" :multiple="100" disabled></yu-xform-item>
          <yu-xform-item label="对应融资金额" ctype="input" placeholder="对应融资金额" name="correFinAmt" rules="required" @change="debounce()" :disabled="isEdit"></yu-xform-item>
          <yu-xform-item label="担保标识" ctype="select" placeholder="担保标识" name="isAddGuar" data-code="STD_GUAR_TYPE" rules="required" :disabled="isEdit"></yu-xform-item>
          ...
          <yu-xform-item label="主键" ctype="input" name="pkId" placeholder="主键" hidden></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
    </div>
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button type="primary" @click="doSaveMain" :hidden="op">保存</yu-button>
    </yu-form-buttons>
  </div>
</template>
<script>
