<template>
  <div id="d1_3_B_BillCard">
    <div id="d1_3_B_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="配偶-资产信息汇总">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="${templetItemVO.itemname}" ctype="input" placeholder="${templetItemVO.itemname}" name="apptCode" hidden></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
      </yu-xform>
    </div>
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button type="primary" @click="customClick('doSaveMainWife')">保存负债认定信息</yu-button>
    </yu-form-buttons>
  </div>
</template>
<script>
