<template>
  ...
  <div>
    ...
    <yu-panel title="经营性收入" :hideFilter="false" :collapseHide="false" :disabled="disabledflg">
        ...
        <yu-xtable ref="refRepayTable"  row-number :base-params="params" border :data="repayData" width="800" v-model="tabledata" :data-url="dataUrl">
          ...
          <yu-xtable-column label="数据来源" prop="dataSour" align="center" ctype="input"></yu-xtable-column>
          <yu-xtable-column label="分析时间段" prop="analyTime" align="center" ctype="datepicker"></yu-xtable-column>
          <yu-xtable-column label="销售额（元）" prop="saleAmt" align="center" ctype="input"></yu-xtable-column>
          <yu-xtable-column label="推算年销售额（元）" prop="yearSaleAmt" align="center" ctype="input"></yu-xtable-column>
          <yu-xtable-column label="利润率（%）" prop="profitRate" align="center" ctype="input"></yu-xtable-column>
          <yu-xtable-column label="年净利润（元）" prop="yearProfit" align="center" ctype="input"></yu-xtable-column>
          <yu-xtable-column label="月收入（元）" prop="mearn" align="center" ctype="input"></yu-xtable-column>
...
export default {
  data: function () {
    return {
      ...
      // dataUrl: backend.cmisBiz + '/api/iqpdisassetincome/',
      rule: [
        {
          required: true,
          message: '必填项',
  ...
  mounted () {
    ...
    yufp.service.request({
      ...
      callback: function (code, message, response) {
        ...
        // yufp.clone(response.data, _this.repayData);
      }
    });
    yufp.service.request({
      method: 'Post',
