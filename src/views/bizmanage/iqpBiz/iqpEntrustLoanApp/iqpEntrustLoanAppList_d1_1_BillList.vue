<template>
  <div>
    <yu-panel title="委托贷款合同申请" :hideFilter="false" :collapseHide="false">
      <yu-xform ref="refForm" form-type="search" v-model="searchFormdata" label-width="120px" :custom-search-fn="customSearch">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="审批状态" ctype="select" data-code="STD_ZB_APPR_STATUS" :datacode-filter="datacodeFilterFn" exclude-key="997,998,990,991" placeholder="审批状态" name="approveStatus"></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
      <yu-button-drop>
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" request-type="POST" :default-load="true">
...
<script>
yufp.lookup.reg('STD_ZB_APPR_STATUS,STD_ZB_CUR_TYP,STD_ZB_GUAR_WAY');
...
export default {
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/iqpentrustloanapp/tosignlist',
      baseParams: {},
