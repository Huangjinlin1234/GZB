...
export default {
  ...
  mounted () {
    // var _this = this;
    // console.log(_this.getFactory().contextData.surveySerno);
    this.surveySerno = this.getFactory().contextData.surveySerno || this.getFactory().contextData.pvpSerno || this.getFactory().contextData.biz_serno;
    this.AfterInit();
  },
  methods: {
    AfterInit () {
