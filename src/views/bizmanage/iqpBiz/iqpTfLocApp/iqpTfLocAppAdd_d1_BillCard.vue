    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="1">
          ...
          <!--<yu-xform-item label="产品编号" ctype="yu-xlmtsub-tree" rules="required" name="prdId" :parms="{limitStrNo:'01'}" @select-fn="commonSelectFn" :show-text="false" :mapping="{'id':'prdId','label':'prdName'}"></yu-xform-item><br>-->
          <yu-xform-item label="产品编号" ctype="yu-dg-prd-pop" name="prdId" rules="required" placeholder="产品编号" @select-fn="commonSelectFn" :mapping="{'prdId':'prdId','prdName':'prdName'}" :param="{'prdType':'04'}" ></yu-xform-item>
          ...
          <yu-xform-item label="合同类型" ctype="select" name="contType" rules="required" data-code="STD_CONT_TYPE" placeholder="合同类型"></yu-xform-item>
          <yu-xform-item label="担保方式" ctype="select" name="guarMode" rules="required" data-code="STD_ZB_GUAR_WAY" placeholder="担保方式" @change="isAllBail"></yu-xform-item>
...
<script>
// 注册字典项
yufp.lookup.reg('STD_ZB_GUAR_WAY,STD_CONT_TYPE');
...
export default{
  ...
  methods: {
    ...
    commonDgContSelect () {
      ...
      var data = { cusId: cusId, lmtAccNo: lmtAccNo, busiType: '06'};
      ...
      yufp.service.request({
        ...
        callback: function (code, message, response) {
          if (response.code == 0) {
            ...
            _this.$xutils.showMsgBox('提示', '获取批复流水号失败!', 350, 150);
            return;
          }
        }
      });
  ...
  watch: {
    'formdata.lmtAccNo': function (val) {
      if (val) {
        this.customParams = {
          condition: {contStatus: '200', lmtAccNo: val, busiType: '06'}
        };
      }
    }
  }
