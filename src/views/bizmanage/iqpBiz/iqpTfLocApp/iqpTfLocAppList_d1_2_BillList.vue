<template>
  <div>
    <yu-panel title="开证合同申请历史" :hideFilter="false" :collapseHide="false">
...
export default {
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/iqptflocapp/donesignlist',
      baseParams: {},
      deleteUrl: this.$backend.cmisBiz + '/api/iqptflocapp/delete/'
    };
  },
  methods: {
    // 字典项过滤
