    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="渠道" ctype="input" name="chnl" rules="required" placeholder="渠道"></yu-xform-item>
...
export default{
  ...
  data: function () {
    return {
      updateUrl: this.$backend.cmisBiz + '/api/lmtsurveyprofileinfo/update',
      addUrl: this.$backend.cmisBiz + '/api/lmtsurveyprofileinfo/',
      formdata: {},
      formType: 'edit',
