...
export default {
  ...
  methods: {
    ...
    onSave () {
      ...
      model.borrowerCusId = this.pageParams.borrowerCusId ? this.pageParams.borrowerCusId : model.cusId; // 其他业务传入值
      model.borrowerCusName = this.pageParams.borrowerCusName ? this.pageParams.borrowerCusName : model.cusName; // 其他业务传入值
      model.borrowerCertCode = this.pageParams.borrowerCertCode ? this.pageParams.borrowerCusName : model.certCode; // 其他业务传入值
