    ...
    <yu-panel title="苏州地方征信查询申请列表" :collapseHide="false">
      <template slot="right">
        <yu-button-drop style="padding: 0;">
          <!-- <yu-button ref="btn_doInsect" v-if="!isGrp" @click="customClick('doInsectSZ')">新增</yu-button> -->
          <yu-button type="primary" ref="btn_doImport" v-if="!isGrp" @click="doImport">引入</yu-button>
          <yu-button type="primary" ref="btn_doUpdate" v-if="!isGrp" @click="customClick('doUpdateSZ')">修改</yu-button>
          <yu-button type="primary" ref="btn_doView" v-if="!isManagerId" @click="customClick('doViewSZ')">查看</yu-button>
          <yu-button type="primary" ref="btn_doDelete" v-if="!isGrp" @click="customClick('doDeleteSZ')">删除</yu-button>
