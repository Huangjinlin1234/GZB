    ...
    <div id="dialog_BillCardContent">
      <yu-xform ref="refForm" width="600px" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="文档模板分类" ctype="select" placeholder="文档模板分类" data-code="STD_ZB_FILE_TYPE" name="fileTplClass" rules="required" disabled></yu-xform-item>
          <yu-xform-item label="文档模板编号" ctype="yu-xcont-tpl" name="fileTplNo" rules="required" placeholder="文档模板编号" @select-fn="commonSelectFn" :mapping="{ contTplCode: 'fileTplNo', contTplName: 'fileName' }" width="680" height="480" :parms="{ condition: { prdId: prdId, tplStatus: 'A' } }"></yu-xform-item>
...
export default {
  ...
  methods: {
    execBillCardDefaultValueFormula: function() {
      ...
      this.formdata.fileTplClass = this.$xutils.getDefaultformulaData("01");
