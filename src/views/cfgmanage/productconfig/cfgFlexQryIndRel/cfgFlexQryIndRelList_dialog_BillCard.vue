    ...
    <div id="dialog_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="关联左表指标配置编码" ctype="yu-xflex-query-grp" name="leftIndexCode" rules="required" placeholder="关联左表指标配置编码" @select-fn="commonSelectFn" :mapping="{'datasource':'datasource','indexCode':'leftIndexCode','alias':'leftTableAlias','tableSour':'leftTableName'}" width="680" height="480" :parms="{'createType':'1'}" ></yu-xform-item>
          ...
          <yu-xform-item label="左表关联字段" ctype="input" placeholder="左表关联字段" name="leftColName" rules="required"></yu-xform-item>
          <yu-xform-item label="关联右表指标配置编码" ctype="yu-xflex-query-grp" name="rightIndexCode" rules="required" placeholder="关联右表指标配置编码" @select-fn="commonSelectFn" :mapping="{'datasource':'datasource','indexCode':'rightIndexCode','alias':'rightTableAlias','tableSour':'rightTableName'}" width="680" height="480" :parms="{'createType':'2'}" ></yu-xform-item>
          ...
          <yu-xform-item label="右表关联字段" ctype="yu-xflex-query-detls" name="rightColName" rules="required" placeholder="右表关联字段" @select-fn="commonSelectFn" :mapping="{'colNameEn':'rightColName'}" width="480" height="480" :parms="{'indexCode':'${rightIndexCode}'}" ></yu-xform-item>
          <yu-xform-item label="关联方式" ctype="select" name="joinWay" rules="required" :options="dicOptions.joinWayOptions" placeholder="关联方式"></yu-xform-item>
