    ...
    <yu-panel title="行名行号配置" :hideFilter="false" :collapseHide="false">
      <yu-xform ref="refForm" label-width="160px" v-model="baseFormdata" style="text-align: center;" :disabled="viewType == 'DETAIL'">
        <yu-xform-group>
          ...
          <yu-xform-item label="行政地区" ctype="input" placeholder="行政地区" name="areaName" hidden></yu-xform-item>
          <yu-xform-item label="地区代码" ctype="input" placeholder="地区代码" name="areaCode" disabled></yu-xform-item>
          ...
          <yu-xform-item label="上级行" ctype="input" placeholder="上级行" name="superBankNo" disabled></yu-xform-item>
