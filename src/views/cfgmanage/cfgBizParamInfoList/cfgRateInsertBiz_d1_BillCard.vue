<template>
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="责任人" ctype="yu-xuser-power" name="managerId" rules="required" placeholder="责任人" @select-fn="commonSelectFn" :mapping="{ loginCode: 'managerId' }" width="720" height="480"></yu-xform-item>
    ...
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button type="primary" @click="customClick('nextStep')">保存</yu-button>
