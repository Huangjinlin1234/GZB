    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules">
        <yu-xform-group :column="1">
            ...
            <yu-xform-item label="资产类型" ctype="select" name="assetType" placeholder="资产类型" data-code="STD_ASPL_ASSET_TYPE" hidden></yu-xform-item>
            <yu-xform-item label="信用配置类型" ctype="select" name="cfgCreditType" placeholder="信用配置类型" data-code="STD_CFG_CREDIT_TYPE" disabled></yu-xform-item>
            <yu-xform-item label="信用等级" ctype="select" name="creditLevel" placeholder="信用等级" data-code="STD_ACC_BANK_CREDIT_LEVEL" disabled ></yu-xform-item>
            <yu-xform-item label="抵质押率" ctype="yu-num" sign="%"  name="pldimnRate" placeholder="抵质押率" :multiple="100"  :precision="2" :min="0" ></yu-xform-item>
