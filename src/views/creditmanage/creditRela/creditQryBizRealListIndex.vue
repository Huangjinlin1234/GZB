...
export default {
  ...
  methods: {
    afterInit () {
      ...
      if (this.getFactory().contextData) {
        ...
        if (this.getFactory().contextData.biz_serno) {
          ...
          this.paramsData.bizType = this.getFactory().contextData.bizType;
          this.selectGrpInfo(this.getFactory().contextData.grpCusId);
      ...
      if (this.$route.meta.params) {
        ...
        if (this.$route.meta.params.biz_serno) {
          ...
          this.paramsData.period = '01';
          this.paramsData.bizType = this.$route.meta.params.bizType;
          this.selectGrpInfo(this.$route.meta.params.grpCusId);
          ...
          this.paramsData.bizType = this.$route.meta.params.bizType;
          this.paramsData.borrowerCusId = this.$route.meta.params.borrowerCusId || this.$route.meta.params.cusId;
    ...
    doInsect () {
      ...
      this.$dialog.open(
        '添加查询用户',
        'creditmanage/creditRela/creditQryBizRealListInsectIndex',
        '880',
        '300',
        _this.paramsData,
        (rtData) => {
    ...
    doInsectSZ () {
      ...
      this.$dialog.open(
        '添加查询用户',
        'creditmanage/creditRela/creditQryBizRealListSZInsectIndex',
        '880',
        '300',
        _this.paramsData,
        (rtData) => {
    ...
    doUpdate () {
      ...
      this.$dialog.open(
        '修改',
        'creditmanage/creditRela/creditQryBizRealListUpdateIndex',
        '880',
        '300',
        params,
        (rtData) => {
    ...
    doUpdateSZ () {
      ...
      this.$dialog.open(
        '修改',
        'creditmanage/creditRela/creditQryBizRealListSZUpdateIndex',
        '880',
        '300',
        params,
        (rtData) => {
    ...
    doView () {
      ...
      this.$dialog.open(
        '查看',
        'creditmanage/creditRela/creditQryBizRealListViewIndex',
        -1,
        -1,
        params,
        () => {}
    ...
    doViewSZ () {
      ...
      this.$dialog.open(
        '查看',
        'creditmanage/creditRela/creditQryBizRealListSZViewIndex',
        880,
        350,
        params,
        () => {}
    ...
    selectGrpInfo (grpNo) {
      ...
      yufp.service.request({
        ...
        async: false,
        method: 'POST',
        url: _this.$backend.cmisCus + '/api/cusgrp/selectCusGrpDtoByGrpNo',
        data: grpNo,
        callback: function (code, message, response) {
          if (response.code == '0') {
            _this.paramsData.borrowerCusId = response.data && response.data.coreCusId;
            _this.paramsData.borrowerCusName = response.data && response.data.coreCusName;
          } else {
            _this.$message({ message: response.erortx, type: 'error' });
          }
        }
