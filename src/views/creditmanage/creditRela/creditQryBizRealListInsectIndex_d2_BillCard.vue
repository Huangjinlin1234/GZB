    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="150px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          <yu-xform-item label="征信查询类别" ctype="select" name="qryCls" rules="required" :options="dicOptions.qryClsOptions" placeholder="征信查询类别"></yu-xform-item>
          ...
          <yu-xform-item label="查询对象证件类型" ctype="select" name="certType" :options="dicOptions.certTypeOptions" placeholder="查询对象证件类型" rules="required"></yu-xform-item>
