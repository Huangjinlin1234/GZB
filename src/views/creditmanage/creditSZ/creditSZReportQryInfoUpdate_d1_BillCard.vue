<template>
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="150px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="主借款客户号" ctype="YuXcusBase" name="borrowerCusId" hidden placeholder="主借款客户号" @select-fn="commonSelectFn" :mapping="{'cusId':'borrowerCusId','cusName':'borrowerCusName','certCode':'borrowerCusName'}" width="480" height="480" :requestUrl="requestUrl" :parms="{'condition':{cusCatalog:'2'}}" ></yu-xform-item>
          ...
          <yu-xform-item label="征信查询对象名称" rules="required" ctype="input" placeholder="征信查询对象名称" name="cusName"></yu-xform-item>
    ...
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button type="primary" v-if="flag" @click="customClick('onContinue')" v-norepeat.loading>保存</yu-button>
      <yu-button type="primary" v-if="flag" @click="customClick('onCommit')" v-norepeat.loading>提交</yu-button>
