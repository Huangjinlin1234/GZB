<template>
  <div id="d1_1_BillCard">
      ...
      <yu-xform ref="refForm" label-width="150px" :form-type="formType" v-model="formdata" hidden-del-val="true" :rules="formRules" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="主借款人信息" :collapseHide="false">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="主借款人证件类型" rules="required" ctype="select" placeholder="主借款人证件类型" name="borrowerCertType" :options="dicOptions.certTypeOptions" disabled></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
        <yu-panel title="查询对象信息" :collapseHide="false">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="征信查询对象号" rules="required" ctype="YuXcusBase" name="cusId" placeholder="征信查询对象号" @select-fn="commonSelectFn" v-show="isChoose" :mapping="{'certType':'certType','cusId':'cusId','cusName':'cusName','certCode':'certCode'}" width="880" height="680" :requestUrl="requestUrl" :parms="{'condition':{cusCatalog:'1'}}" ></yu-xform-item>
            <yu-xform-item label="征信查询对象号" rules="required" ctype="YuXcusBase" name="cusId" placeholder="征信查询对象号" @select-fn="commonSelectFn" v-show="!isChoose" :mapping="{'certType':'certType','cusId':'cusId','cusName':'cusName','certCode':'certCode'}" width="880" height="680" :requestUrl="requestUrl" :parms="{'condition':{cusCatalog:'1', managerId: managerId}}" ></yu-xform-item>
        ...
        <yu-panel title="授权信息" :collapseHide="false">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="授权模式" rules="required" ctype="select" name="authWay" :options="dicOptions.authWayOptions" placeholder="授权模式"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
      </yu-xform>
    </div>
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      ...
      <yu-button type="primary" v-if="isCommit" @click="customClick('onCommit')" v-norepeat.loading>提交</yu-button>
...
yufp.lookup.reg('STD_ZB_CERT_TYP, STD_AUTH_WAY');
export default{
  name: 'D11BillCard',
  mixins: [mixinForm],
  data: function () {
    ...
    return {
      ...
      formdata: {},
      formType: 'edit',
      dicOptions: {qryClsOptions: [{key: '0', value: '个人'}, {key: '1', value: '企业'}, {key: '3', value: '苏州地方'}], qryResnOptions: [{key: '02', value: '贷款审批'}, {key: '08', value: '担保资格审查'}, {key: '22', value: '法人代表，出资人及关联人等资信查询'}, {key: '25', value: '资信审查'}, {key: '27', value: '贷后管理'}], certTypeOptions: [{key: 'C', value: '户口簿'}, {key: 'A', value: '居民身份证'}, {key: 'B', value: '护照'}, {key: '11', value: '军人身份证件'}, {key: 'D', value: '港澳居民来往内地通行证'}, {key: 'E', value: '台湾同胞来往内地通行证'}, {key: '12', value: '外国人居留证'}, {key: 'Y', value: '警官证'}, {key: '13', value: '香港身份证'}, {key: '14', value: '澳门身份证'}, {key: '15', value: '台湾身份证'}, {key: '16', value: '其他证件'}], borrowRelOptions: [{key: '001', value: '主借款人'}, {key: '005', value: '共同借款人'}, {key: '007', value: '担保人'}, {key: '008', value: '法定代表，出资人及关联人等'}, {key: '009', value: '其他关系人'}], authbookContentOptions: [{key: '001', value: '审核本人贷款申请'}, {key: '002', value: '审核本人贷记卡、准贷记卡申请'}, {key: '003', value: '审核本人作为担保人'}, {key: '004', value: '受理法人或其他组织的贷款申请或其作为担保人，需要查询本人作为法定代表人、出资人及关联人信用状况'}, {key: '005', value: '资信审查'}, {key: '006', value: '特约商户实名审查'}, {key: '007', value: '对已发放的信贷业务进行贷后风险管理'}], approveStatusOptions: [{key: '000', value: '待发起'}, {key: '111', value: '审批中'}, {key: '997', value: '审批通过'}], qryStatusOptions: [{key: '001', value: '查询中'}, {key: '002', value: '查询失败'}, {key: '003', value: '已查询'}], qryFlagOptions: [{key: '01', value: '人工'}, {key: '02', value: '业务发起'}], authWayOptions: [{key: '01', value: '现场授权'}, {key: '02', value: '远程授权'}] },
      formRules: {
  ...
  computed: {
    changeData () {
      const { borrowRel, borrowerCusId, borrowerCusName, borrowerCertCode, borrowerCertType, cusId, cusName, certType, certCode, authWay } = this.formdata;
      return {
        borrowRel, borrowerCusId, borrowerCusName, borrowerCertCode, borrowerCertType, cusId, cusName, certType, certCode, authWay
      };
    },
    changeAuthbookNo () {
