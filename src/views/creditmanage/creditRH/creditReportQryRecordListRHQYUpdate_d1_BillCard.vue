      ...
      <yu-xform ref="refForm" label-width="150px" :form-type="formType" v-model="formdata" :rules="formRules" :disabled="formDis" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="主借款人信息" :collapseHide="false" v-if="isBorrowRel">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="主借款人证件类型" rules="required" ctype="input" placeholder="主借款人证件类型" name="borrowerCertType" hidden disabled></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
        <yu-panel title="查询对象信息" :collapseHide="false">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="征信查询对象号" ctype="YuXcusBase" name="cusId" placeholder="征信查询对象号" @select-fn="commonSelectFn" v-show="isChoose" :mapping="{'certType':'certType','cusId':'cusId','cusName':'cusName','certCode':'certCode'}" width="880" height="680" :requestUrl="requestUrl" :parms="{'condition':{cusCatalog:'2'}}" ></yu-xform-item>
            <yu-xform-item label="征信查询对象号" ctype="YuXcusBase" name="cusId" placeholder="征信查询对象号" @select-fn="commonSelectFn" v-show="!isChoose" :mapping="{'certType':'certType','cusId':'cusId','cusName':'cusName','certCode':'certCode'}" width="880" height="680" :requestUrl="requestUrl" :parms="{'condition':{cusCatalog:'2', managerId: managerId}}" ></yu-xform-item>
  ...
  methods: {
    ...
    queryAuthBookLast () {
      ...
      yufp.service.request({
        ...
        data: {condition: JSON.stringify({qryCls: '1'})},
