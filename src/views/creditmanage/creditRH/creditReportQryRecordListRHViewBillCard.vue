<template>
  <div id="d1_BillCard">
      ...
      <yu-xform ref="refForm" label-width="130px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="主借款人信息" :collapseHide="false">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="主借款人证件类型" ctype="select" placeholder="主借款人证件类型" name="borrowerCertType" data-code="STD_ZB_CERT_TYP"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
    ...
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button icon="yx-undo2" type="primary" @click="customClick('onBack')">取消</yu-button>
    </yu-form-buttons>
  </div>
</template>
<script>
