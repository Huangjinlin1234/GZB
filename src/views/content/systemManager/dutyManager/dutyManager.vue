  ...
  <div id="dutyManager">
    ...
    <yu-xdialog :title="viewTitle[viewType]" :visible.sync="dialogVisible" size="tiny">
      <yu-xform ref="dutyForm" v-model="formdata" :form-type="formType" label-width="100px" :rules="formRules">
        ...
        <yu-xform-item :label="$t('dutyManager.ssjg')" name="orgName" ctype="yufp-search-tree" :params="treeParams" :select-value="selectValue" :details="viewType === 'DETAIL'" :details-value="detailsValue" @node-click="changeOrgFn"></yu-xform-item>
    ...
    <!--岗位用户-->
    <yu-xdialog :title="$t('dutyManager.gwyh')" :visible.sync="userDialogVisible" size="small">
      <yu-xform v-model="userFormdata" related-table-name="userTable" form-type="search">
...
export default {
  ...
  data: function() {
    return {
      ...
      treeUrl: backend.appOcaService + '/api/adminsmorg/orgtreequery', // 岗位树请求 url
