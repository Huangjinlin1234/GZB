...
<template>
  <div class="yu-menu-config clear">
    ...
    <div class="right-content frame-height">
      ...
      <div class="content-box">
        <!--菜单详情表单-->
        <yu-xform v-show="currentCheckedNodeId" ref="menuForm" class="menu-form" v-model="menuFormData" label-width="150px" :form-type="menuFormType">
          <yu-xform-group :column="1">
            ...
            <yu-xform-item :hidden="menuFormData.menuClassify === '1'" :label="$t('menuConfig.ywgn')" name="funcUrl" :maxlength="23" :rules="funcUrlRule" :placeholder="$t('menuConfig.qxz')" icon="search" @focus="openFunctionDialog('menuConfig.xzywgn')" readonly @click="openFunctionDialog('menuConfig.xzywgn')"></yu-xform-item>
            <yu-xform-item :hidden="menuFormData.menuClassify === '1'" :label="$t('menuConfig.cdmc')" name="menuName" :maxlength="23" :rules="menuNameRule" :placeholder="$t('menuConfig.qsr')"></yu-xform-item>
            <yu-xform-item :hidden="menuFormData.menuClassify === '0'" :label="$t('menuConfig.cjml')" name="menuName" :maxlength="23" :rules="menuNameRule" :placeholder="$t('menuConfig.qsr')"></yu-xform-item>
    ...
    <!--业务功能选择-->
    <yu-xdialog class="yu-menu-function-dialog" :title="xdialogTit" :visible.sync="isShowFunctionDialog" size="large" height="620px" destroy-on-close>
    ...
    <!--业务功能详情-->
    <yu-xdialog ref="funcDetailDialog" class="func-detail-dialog" :title="funcDetailDialogTitle" :visible.sync="isShowFuncDetailDialog" size="tiny" :min-height="240">
  ...
  methods: {
    ...
    */
    ...
    getMenuFormData: function (childrenLength) {
      ...
      _this.$request({
        method: 'GET',
        data: { menuId: this.currentCheckedNodeId },
    ...
    deleteMenu: function (isDeleteMenuFormData) { // isDeleteMenuFormData为true 表示删除menuForm展示的数据的菜单, 否则是批量删除checkbox选中的菜单
      var _this = this;
