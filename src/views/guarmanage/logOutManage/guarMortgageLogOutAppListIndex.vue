<template>
  <yu-tabs  type="card">
    <yu-tab-pane label="抵押注销申请">
  <d1-billlist ref="d1_BillList"></d1-billlist>
    </yu-tab-pane>
    <yu-tab-pane label="抵押注销历史">
  <d2-billlist ref="d2_BillList"></d2-billlist>
    </yu-tab-pane>
  </yu-tabs>
</template>
<script>
import d1Billlist from './guarMortgageLogOutAppList_d1_BillList.vue';
import d2Billlist from './guarMortgageLogOutAppList_d2_BillList.vue';
...
export default {
  ...
  methods: {
    ...
    doUpdate () {
      ...
      this.$dialog.open('抵押注销修改', 'guarmanage/registerManage/guarMortgageRegisterAppFormIndex.vue', -1, -1, opJso);
    },
