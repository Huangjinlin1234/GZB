<template>
  <div>
    <yu-panel title="抵押注销申请列表" panel-type="simple">
      <yu-xform ref="refForm" form-type="search" v-model="searchFormdata" label-width="120px" :custom-search-fn="customSearch">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="审批状态" ctype="select" data-code="STD_ZB_APPR_STATUS" placeholder="请选择" name="approveStatus"></yu-xform-item>
          <yu-xform-item label="是否在线办理抵押" ctype="select" data-code="STD_ZB_YES_NO" placeholder="请选择" name="isRegOnline" ></yu-xform-item>
          <yu-xform-item label="抵押注销类型" ctype="select" data-code="STD_REG_SUB_TYPE" placeholder="请选择" name="regSubType" ></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
      <template>
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :base-params="searchData" :data-url="dataUrl" :default-load="true" request-type="POST">
        ...
        <yu-xtable-column label="抵押注销类型" prop="regSubType" data-code="STD_REG_SUB_TYPE" width="120"></yu-xtable-column>
        <yu-xtable-column label="是否在线办理" prop="isRegOnline" data-code="STD_ZB_YES_NO" width="120"></yu-xtable-column>
        <yu-xtable-column label="担保合同编号" prop="guarContNo"  width="120">
...
<script>
yufp.lookup.reg('STD_ZB_YES_NO,STD_ZB_APPR_STATUS,REG_SUB_TYPE,STD_REG_TYPE,STD_ZB_GUAR_CONT_TYPE');
