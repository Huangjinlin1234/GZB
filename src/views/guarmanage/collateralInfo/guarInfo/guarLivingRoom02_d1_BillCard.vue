    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="200px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="押品统一编号" ctype="input" placeholder="押品统一编号" name="guarNo" disabled hidden  ></yu-xform-item>
          ...
          <yu-xform-item label="一手/二手标识 " ctype="select" name="isUsed" disabled hidden data-code="STD_ZB_IS_USED" placeholder="一手/二手标识 "  ></yu-xform-item>
          ...
          <yu-xform-item label="房屋产权期限信息（年）" ctype="input" placeholder="房屋产权期限信息（年）" name="housePrDesc" disabled hidden  ></yu-xform-item>
          <yu-xform-item label="楼盘（社区）名称" ctype="input" placeholder="楼盘（社区）名称" name="communityName" rules="required"  ></yu-xform-item>
          ...
          <yu-xform-item label="房地产所在地段情况  " ctype="select" name="housePlaceInfo" disabled hidden data-code="STD_ZB_HOUSE_PLACE_INFO" placeholder="房地产所在地段情况  "  ></yu-xform-item>
          <yu-xform-item label="周边环境 " ctype="select" name="arrEnv" disabled hidden data-code="STD_ZB_ARR_ENV" placeholder="周边环境 "  ></yu-xform-item>
          <yu-xform-item label="套型" ctype="select" name="fSty" disabled hidden data-code="STD_ZB_F_STY" placeholder="套型"  ></yu-xform-item>
          <yu-xform-item label="房屋状态 " ctype="select" name="houseSta" disabled hidden data-code="STD_ZB_HOUSE_STA" placeholder="房屋状态 "  ></yu-xform-item>
          ...
          <yu-xform-item label="地面构造 " ctype="select" name="groundStructure" disabled hidden data-code="STD_ZB_GROUND_STRUCTURE" placeholder="地面构造 "  ></yu-xform-item>
          <yu-xform-item label="所在/注册省份" ctype="input" placeholder="所在/注册省份" name="provinceCd" disabled hidden  ></yu-xform-item>
          <yu-xform-item label="屋顶构造" ctype="select" name="roofStructure" disabled hidden data-code="STD_ZB_GROUND_STRUCTURE" placeholder="屋顶构造"  ></yu-xform-item>
          ...
          <yu-xform-item label="朝向" ctype="select" name="orientations" disabled hidden data-code="STD_ZB_ORIENTATIONS" placeholder="朝向"  ></yu-xform-item>
          ...
          <yu-xform-item label="通风采光 " ctype="select" name="ventilationAndLighting" disabled hidden data-code="STD_ZB_AND_LIGHTING" placeholder="通风采光 "  ></yu-xform-item>
          <yu-xform-item label="临街状况 " ctype="select" name="streetSituation" disabled hidden data-code="STD_ZB_STREET_SITUATION" placeholder="临街状况 "  ></yu-xform-item>
          ...
          <yu-xform-item label="车库/车位类型 " ctype="select" name="carportType" rules="required" data-code="STD_ZB_CARPORT_TYPE" placeholder="车库/车位类型 "  ></yu-xform-item>
          ...
          <yu-xform-item label="开发商名称" ctype="input" placeholder="开发商名称" name="developersName" disabled hidden ></yu-xform-item>
          ...
          <yu-xform-item label="是否有独立产权证" ctype="input" placeholder="是否有独立产权证" name="propertyPermitsInd" disabled hidden ></yu-xform-item>
          ...
          <yu-xform-item label="责任人" ctype="input" placeholder="责任人" name="managerId" isabled hidden ></yu-xform-item>
...
export default {
  ...
  mounted () {
    this.guarTypeCd = this.pageData.guarTypeCd;
  ...
  methods: {
    afterInit () {
      ...
      if (_this.formType == 'ADD') {
        ...
        _this.queryData(_this.serno);
      }
    },
    queryData (serno) {
      const _this = this;
      _this.$request({
        url: _this.$backend.cmisBiz + '/api/guarinflivingroom/queryBySerno',
        async: false,
        method: 'post',
        data: {'serno': serno}
      }).then((response) => {
