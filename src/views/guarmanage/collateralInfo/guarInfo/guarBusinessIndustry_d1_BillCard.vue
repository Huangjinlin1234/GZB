<template>
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="200px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent" number-formatter="0000000000000.00">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="是否两证合一" ctype="select" name="twocard2oneInd" rules="required" data-code="STD_ZB_YES_NO" placeholder="是否两证合一"></yu-xform-item>
          ...
          <yu-xform-item label="物业情况" ctype="select" name="propertyCase" rules="required" data-code="STD_ZB_PROPERTY"  placeholder="物业情况"></yu-xform-item>
          ...
          <yu-xform-item label="房地产买卖合同编号" ctype="input" placeholder="房地产买卖合同编号" name="businessHouseNo"></yu-xform-item>
          <yu-xform-item label="产权证号" ctype="input" placeholder="产权证号" name="houseLandNo"></yu-xform-item>
          <yu-xform-item label="购买价格（元）" ctype="yu-num" number-formatter="0,000.00" placeholder="购买价格（元）" name="purchaseAccnt" max="9999999999999.99" min="0.00" :precision="2"></yu-xform-item>
          <yu-xform-item label="购买日期" ctype="datepicker" name="purchaseDate" value-format="yyyy-MM-dd" placeholder="购买日期"></yu-xform-item>
          <yu-xform-item label="竣工日期" ctype="input" placeholder="竣工日期" name="endDate" disabled hidden></yu-xform-item>
          <yu-xform-item label="建筑面积" ctype="num" placeholder="建筑面积" name="buildArea" max="9999999999999.99" min="0.00" value="0" :precision="2"></yu-xform-item>
          <yu-xform-item label="建成年份" ctype="input" placeholder="建成年份" name="activateYears"></yu-xform-item>
          <yu-xform-item label="楼龄" ctype="input" placeholder="楼龄" name="floorAge"></yu-xform-item>
          <yu-xform-item label="所在区域" ctype="yu-xdic-tree-addr" @select-fn="commonSelectFn" width="480" height="480" :parms="{ optType: 'STD_ZB_AREA_CODE',levels: '5'}" :mapping="{'id':'cityCd'}" placeholder="所在区域" name="provinceCd"></yu-xform-item>
          <!--<yu-xform-item label="所在/注册市" ctype="input" placeholder="所在/注册市" name="cityCd"></yu-xform-item>
          <yu-xform-item label="所在县（区）" ctype="input" placeholder="所在县（区）" name="countyCd"></yu-xform-item>
          <yu-xform-item ctype="yu-linkage-select" data-structure="tree" :options="treeOption" :colspan="16" :level="3" :props="props" :labels="label" name="linkTree"></yu-xform-item>-->
          ...
          <yu-xform-item label="房地产所在地段情况 std_zb" ctype="input" placeholder="房地产所在地段情况 std_zb" name="housePlaceInfo" disabled hidden></yu-xform-item>
          ...
          <yu-xform-item label="土地使用权单位" ctype="input" placeholder="土地使用权单位" name="landUseUnit" disabled hidden></yu-xform-item>
          ...
          <yu-xform-item label="物业类型 std_zb_prop" ctype="input" placeholder="物业类型 std_zb_prop" name="houseType" disabled hidden></yu-xform-item>
          <yu-xform-item label="发证日期" ctype="input" placeholder="发证日期" name="issueCertiDate" disabled hidden></yu-xform-item>
          <yu-xform-item label="工业房地产开发模式 std_zb" ctype="input" placeholder="工业房地产开发模式 std_zb" name="industryDecelopModel" disabled hidden></yu-xform-item>
          <yu-xform-item label="工业园区等级" ctype="input" placeholder="工业园区等级" name="industryZoneLevel" disabled hidden></yu-xform-item>
          <yu-xform-item label="盈利模式 std_zb_prof" ctype="input" placeholder="盈利模式 std_zb_prof" name="profitModel" disabled hidden></yu-xform-item>
          <yu-xform-item label="基础设施情况描述" ctype="input" placeholder="基础设施情况描述" name="bascFaciDesc" disabled hidden></yu-xform-item>
          <yu-xform-item label="是否满足该行业厂房设计标准 st" ctype="input" placeholder="是否满足该行业厂房设计标准 st" name="isIndustryDesignPlant" disabled hidden></yu-xform-item>
          <yu-xform-item label="部分抵押描述" ctype="input" placeholder="部分抵押描述" name="partRegPositionDesc"></yu-xform-item>
          <yu-xform-item label="所属地理位置" ctype="select" placeholder="所属地理位置" name="belongArea" rules="required" data-code="STD_ZB_LOCATED_POSITION"></yu-xform-item>
          ...
          <yu-xform-item label="楼盘名称" ctype="input" placeholder="楼盘名称" name="communityName" disabled hidden></yu-xform-item>
          <yu-xform-item label="商业繁华程度 std_zb_bu" ctype="input" placeholder="商业繁华程度 std_zb_bu" name="bustlingLevel" disabled hidden></yu-xform-item>
          <yu-xform-item label="交通便捷程度 std_zb_tr" ctype="input" placeholder="交通便捷程度 std_zb_tr" name="trafficConvenientLevel" disabled hidden></yu-xform-item>
          <yu-xform-item label="外界环境 std_zb_envi" ctype="input" placeholder="外界环境 std_zb_envi" name="environment" disabled hidden></yu-xform-item>
          <yu-xform-item label="空置率" ctype="input" placeholder="空置率" name="vacancyRate" disabled hidden></yu-xform-item>
          <yu-xform-item label="临街情况 std_zb_stre" ctype="input" placeholder="临街情况 std_zb_stre" name="streetSituation" disabled hidden></yu-xform-item>
          <yu-xform-item label="是否位于城市地带 std_zb_" ctype="input" placeholder="是否位于城市地带 std_zb_" name="isUrbanZone" disabled hidden></yu-xform-item>
          <yu-xform-item label="建筑外观与公共装修 std_zb" ctype="input" placeholder="建筑外观与公共装修 std_zb" name="buildPubFit" disabled hidden></yu-xform-item>
          <yu-xform-item label="物业管理资质等级 std_zb_" ctype="input" placeholder="物业管理资质等级 std_zb_" name="realtyManaNaturLevel" disabled hidden></yu-xform-item>
...
export default {
  ...
  methods: {
    ...
    queryData (serno) {
      const _this = this;
      _this.$request({
        url: _this.$backend.cmisBiz + '/api/guarinfbusinessindustryhousr/queryBySerno',
        async: false,
        method: 'post',
        data: {'serno': serno}
      }).then((response) => {
    ...
    execBillCardDefaultValueFormula: function () {
      this.formdata.purchaseAccnt = this.$xutils.getDefaultformulaData('0');
