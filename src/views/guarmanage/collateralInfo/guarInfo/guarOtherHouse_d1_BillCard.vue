    ...
    <div id="d1_BillCardContent">
      ...
      >
        <yu-xform-group :column="2">
          ...
          ></yu-xform-item>
          <yu-xform-item
            label="现房/期房标识 std_zb_h"
            ctype="input"
            placeholder="现房/期房标识 std_zb_h"
            name="readyOrPeriodHouse"
            disabled
            hidden
          ></yu-xform-item>
          <yu-xform-item
            label="预购商品房预告登记证明号"
            ctype="input"
            placeholder="预购商品房预告登记证明号"
            name="purchseHouseNo"
            disabled
            hidden
          ></yu-xform-item>
          <yu-xform-item
            label="预购商品房抵押权预告登记证明号"
            ctype="input"
            placeholder="预购商品房抵押权预告登记证明号"
            name="purchseHouseRegNo"
            disabled
            hidden
          ></yu-xform-item>
          <yu-xform-item
          ...
          <yu-xform-item
            label="预售许可证有效期"
            ctype="input"
            placeholder="预售许可证有效期"
            name="presellPermitValDate"
            disabled
            hidden
          ></yu-xform-item>
          <yu-xform-item
            ...
            ctype="input"
            placeholder="预计交房年月"
            name="predictOthersDate"
            disabled
            hidden
          ></yu-xform-item>
          <yu-xform-item
            label="一手/二手标识 std_zb_y"
            ctype="input"
            placeholder="一手/二手标识 std_zb_y"
            name="isUsed"
            disabled
            hidden
          ></yu-xform-item>
          <yu-xform-item
            label="是否两证合一 std_zb_ye"
            ctype="input"
            placeholder="是否两证合一 std_zb_ye"
            name="twocard2oneInd"
            disabled
            hidden
          ></yu-xform-item>
          ...
          <yu-xform-item
            ...
            name="houseProperty"
            rules="required"
            placeholder="房产使用情况" data-code="STD_ZB_GUAR_UTIL_CASE"
          ></yu-xform-item>
          <yu-xform-item
            label="销售许可证编号"
            ctype="input"
          ...
          <yu-xform-item
            label="房、地是否均已抵押我行"
            ctype="select"
            name="houseLandPledgeInd"
            rules="required"
            data-code="STD_ZB_YES_NO"
            placeholder="房、地是否均已抵押我行"
          ></yu-xform-item>
          <yu-xform-item
            label="该产证是否全部抵押"
            ctype="select"
            name="houseAllPledgeInd"
            rules="required"
            data-code="STD_ZB_YES_NO"
            placeholder="该产证是否全部抵押"
          ></yu-xform-item>
          <yu-xform-item
            label="部分抵押描述"
            ctype="input"
          ...
          ></yu-xform-item>
          <yu-xform-item
            label="是否本次申请所购房产 std_z"
            ctype="input"
            placeholder="是否本次申请所购房产 std_z"
            name="applyForHouse"
            disabled
            hidden
          ></yu-xform-item>
          <yu-xform-item
            label="抵押住房是否权属人唯一住所"
            ctype="select"
            name="houseOwnershipInd"
            data-code="STD_ZB_YES_NO"
            placeholder="抵押住房是否权属人唯一住所"
            rules="required"
          ></yu-xform-item>
          <yu-xform-item
            label="建筑面积"
          ...
          <yu-xform-item
            ...
            name="houseStructure"
            rules="required"
            data-code="STD_ZB_HOUSE_STRUC"
            placeholder=" 房屋结构"
          ></yu-xform-item>
          <yu-xform-item
            label="地面构造"
            ctype="select"
            name="groundStructure"
            rules="required"
            data-code="STD_ZB_DMWDGZ"
            placeholder="地面构造"
          ></yu-xform-item>
          <yu-xform-item
            label="屋顶构造"
          ...
          <yu-xform-item
            label="所属土地使用权人"
            ctype="input"
            placeholder="所属土地使用权人"
            name="landUseUnit"
            disabled
            hidden
          ></yu-xform-item>
          <yu-xform-item
            label="房产类别 std_zb_inv_"
            ctype="input"
            placeholder="房产类别 std_zb_inv_"
            name="realproCls"
            disabled
            hidden
          ></yu-xform-item>
          ...
          ></yu-xform-item>
          <yu-xform-item
            label="房产取得方式  std_zb_e"
            ctype="input"
            placeholder="房产取得方式  std_zb_e"
...
export default {
  ...
  data: function () {
    return {
      updateUrl: this.$backend.cmisBiz + '/api/guarinfotherhouse/update',
      addUrl: this.$backend.cmisBiz + '/api/guarinfotherhouse/',
      formdata: {},
      formType: 'edit',
      formRules: {},
      imageUrls: {},
  ...
  methods: {
    ...
    queryData (serno) {
      const _this = this;
      _this.$request({
        url: _this.$backend.cmisBiz + '/api/guarinfotherhouse/queryBySerno',
        async: false,
        method: 'post',
        data: {'serno': serno}
      }).then((response) => {
