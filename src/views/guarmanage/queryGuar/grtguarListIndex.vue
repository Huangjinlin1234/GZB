<template>
  <d1-billlist ref="d1_BillList" :params="paramsBillCard"></d1-billlist>
</template>
<script>
import d1Billlist from './grtguar_BillList.vue';
export default {
  ...
  methods: {
    ...
    //   });
      this.d1_BillList.queryDataByCondition({
        grtFlag: this.$route.meta.params.grtFlag,
        guarNo: this.$route.meta.params.guarNo
      });
      // 过滤申请状态，隐藏【信用】等数据字典
      this.d1_BillList.setSelectOptions('guarWay', 'hidden', '400');
      this.paramsBillCard['grtFlag'] = this.$route.meta.params.grtFlag;
      this.paramsBillCard['guarNo'] = this.$route.meta.params.guarNo;
    },
