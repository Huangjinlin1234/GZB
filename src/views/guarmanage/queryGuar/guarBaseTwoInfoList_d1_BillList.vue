    ...
    <yu-panel title="输入查询条件" panel-type="post">
      <yu-xform ref="refForm" form-type="search" v-model="searchFormdata" related-table-name="refTable" label-width="120px" :custom-search-fn="customSearch">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="质押物编号" ctype="input" placeholder="模糊查询" name="guarNo" fuzzy-query="both"></yu-xform-item>
          <yu-xform-item label="质押物名称" ctype="input" placeholder="模糊查询" name="pldimnMemo" fuzzy-query="both"></yu-xform-item>
          <yu-xform-item label="质押人客户编号" ctype="input" placeholder="模糊查询" name="guatCusId" fuzzy-query="both"></yu-xform-item>
          <yu-xform-item label="质押人名称" ctype="input" placeholder="模糊查询" name="guarCusName" fuzzy-query="both"></yu-xform-item>
          <!--<yu-xform-item label="责任机构" ctype="input" placeholder="责任机构" name="inputBrIdName" hidden></yu-xform-item>-->
          <yu-xform-item label="质押物状态" ctype="select" data-code="STD_ZB_GUAR_STATE" placeholder="质押物状态" name="guarState" ></yu-xform-item>
          <yu-xform-item label="质押物类型" ctype="select" data-code="STD_GRT_FLAG" placeholder="质押物类型" name="grtFlag" ></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
      </yu-panel>
    <yu-panel title="质押品列表" panel-type="post">
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="searchData" :default-load="false" request-type="POST">
        ...
        <yu-xtable-column label="质押人名称" prop="guarCusName"></yu-xtable-column>
        <yu-xtable-column label="质押物类型" prop="grtFlag" data-code="STD_GRT_FLAG"></yu-xtable-column>
        <yu-xtable-column label="评估金额(元)" prop="lmtEvalAmt" :formatter="Currency"></yu-xtable-column>
        <yu-xtable-column label="质押物状态" prop="guarState" data-code="STD_ZB_GUAR_STATE" ></yu-xtable-column>
