<template>
  <div>
    <yu-panel title="权证续借申请" panel-type="simple">
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" show-hidden-menu="true" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="searchData" :default-load="true"  request-type="POST">
        ...
        <yu-xtable-column label="权证出入库申请类型" prop="warrantAppType" data-code="STD_WARRANT_APP_TYPE" width="160"></yu-xtable-column>
        ...
        <yu-xtable-column label="权证预计归还时间" prop="preBackDate" width="160"></yu-xtable-column>
...
lookup.reg('STD_GUAR_TYPE,STD_GRT_FLAG');
export default{
