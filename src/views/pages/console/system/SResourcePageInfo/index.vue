<template>
  <div class="resource-container">
    ...
    <add-resource :dialog-visible="isShowResource" :data="resource"></add-resource>
    <res-operation :dialog-visible.sync="isShowResOper" :page-type="pageType" :form-data="resourceOper"></res-operation>
  </div>
</template>
