      ...
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="最高额担保合同">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="借款人编号" ctype="yu-xcustom" name="borrowerId" rules="required" placeholder="借款人编号" @select-fn="commonSelectFn" :mapping="{'certType':'assureCertType','cusId':'borrowerId','cusName':'borrowerName','certCode':'assureCertCode'}" width="700" height="480" :parms="{'oprType':'01','openType':'01'}" ></yu-xform-item>
