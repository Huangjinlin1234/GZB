<template>
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="基本信息" panel-type="simple">
          <yu-xform-group :column="2">
            <yu-xform-item label="借款人编号" ctype="yu-xcustom" name="cusId" rules="required" disabled placeholder="借款人编号" @select-fn="commonSelectFn" :mapping="{'cusId':'borrowerId','name':'borrowerName'}" width="730" height="480" :parms="{'belgLine':'bl300','cusState':'20','oprType':'01'}" ></yu-xform-item>
            <yu-xform-item label="借款人名称" ctype="input" placeholder="借款人名称" name="cusName" rules="required" disabled></yu-xform-item>
            ...
            <yu-xform-item label="担保合同类型" ctype="select" name="guarContType" rules="required" disabled data-code="STD_ZB_GUAR_CONT_TYPE" placeholder="担保合同类型"></yu-xform-item>
            ...
            <yu-xform-item label="期限类型" ctype="select" name="termType" rules="required" data-code="STD_ZB_TERM_TYP" placeholder="期限类型" hidden></yu-xform-item>
            <yu-xform-item label="担保期限" ctype="yu-num" name="guarTerm" rules="required" placeholder="担保期限" :precision="0" :min="0" hidden></yu-xform-item>
            <yu-xform-item label="担保已用金额" ctype="yu-currency" name="guarAmtUsed" disabled placeholder="担保已用金额" :min="0" ></yu-xform-item>
            <yu-xform-item label="担保可用金额" ctype="yu-currency" name="guarAmtAvailable" disabled placeholder="担保可用金额" :min="0" hidden></yu-xform-item>
            ...
            <yu-xform-item label="担保合同状态" ctype="select" name="guarContState" rules="required" disabled data-code="STD_GUAR_CONT_STATE" placeholder="担保合同状态"></yu-xform-item>
        ...
        <yu-panel title="登记信息" panel-type="simple">
          <yu-xform-group :column="2">
            <yu-xform-item label="责任人" ctype="input" name="managerIdName" placeholder="责任人"></yu-xform-item>
            <yu-xform-item label="责任机构" ctype="input" name="managerBrId" hidden placeholder="责任机构"></yu-xform-item>
            <yu-xform-item label="责任机构" ctype="input" name="managerBrIdName" rules="required" placeholder="责任机构" width="680" height="480" ></yu-xform-item>
            ...
            <yu-xform-item label="更新日期" ctype="datepicker" name="updDate" value-format="yyyy-MM-dd" disabled placeholder="更新日期" hidden></yu-xform-item>
    ...
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
        <yu-button type="primary" @click="customClick('onSign')" v-if="sign">签订</yu-button>
        <yu-button type="primary" @click="customClick('onLogout')" v-if="logout">注销</yu-button>
...
export default{
  ...
  data: function () {
    return {
      ...
      addUrl: this.$backend.cmisBiz + '/api/grtguarcont/queryList',
      formdata: {},
      formType: 'edit',
      formRules: { },
      imageUrls: {},
