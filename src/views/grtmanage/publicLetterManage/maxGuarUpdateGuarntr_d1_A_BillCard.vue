    ...
    <div id="d1_A_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="是否浮动抵押" ctype="select" name="isFloatPld" disabled hidden placeholder="是否浮动抵押"></yu-xform-item>
          <yu-xform-item label="质押合同类型" ctype="select" name="pldContType" disabled hidden placeholder="质押合同类型"></yu-xform-item>
...
export default{
  ...
  methods: {
    execBillCardDefaultValueFormula: function () {
      ...
      this.formdata.guarPkId = this.$xutils.getUUID();
      this.formdata.guarCurType = 'CNY';
