    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="140px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="是否授信项下" ctype="select" name="isUnderLmt" rules="required" data-code="STD_ZB_YES_NO" placeholder="是否授信项下"></yu-xform-item>
          <yu-xform-item label="是否追加担保" ctype="select" name="isSuperaddGuar" rules="required" data-code="STD_ZB_YES_NO" placeholder="是否追加担保"></yu-xform-item>
          <yu-xform-item label="担保合同类型" ctype="select" name="guarContType" rules="required" data-code="STD_ZB_GUAR_CONT_TYPE" placeholder="担保合同类型"></yu-xform-item>
          ...
          <yu-xform-item label="担保合同金额" ctype="input" placeholder="担保合同金额" name="guarAmt" disabled hidden></yu-xform-item>
          ...
          <yu-xform-item label="担保到期日" ctype="input" placeholder="担保到期日" name="guarEndDate" disabled hidden></yu-xform-item>
