...
<script>
import d1Billlist from './cusIntbankQuery_BillList.vue';
export default {
  ...
  methods: {
    ...
    // 查看
    doQuery () {
      const json = this.d1BillList.getSelectedRowData();
      ...
      //   json,
      //   () => {
      //     this.$xutils.getParentPage('d1BillList', 'queryDataByCondition');
      //   }
      // );
