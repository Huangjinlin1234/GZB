      ...
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-panel title="基本信息">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="同业机构(行)英文名称" ctype="input" placeholder="同业机构(行)英文名称" name="cusEnName"></yu-xform-item>
            ...
            <yu-xform-item label="行业" ctype="input" placeholder="行业" name="tradeClass"></yu-xform-item>
            ...
            <yu-xform-item label="同业机构行号" ctype="yu-xbank" rules="required" placeholder="同业机构行号" name="largeBankNo" @select-fn="commonSelectFn" :mapping="{ bankNo: 'largeBankNo', bankName: 'largeBankName' }" width="480" height="480" :selectionType="radio"></yu-xform-item>
           ...
           <yu-xform-item label="同业机构类型" ctype="yu-xdic-tree" rules="required" placeholder="同业机构类型" name="intbankType" @select-fn="commonSelectFn" width="480" height="480" :parms="{ optType: 'STD_ZB_INTBANK_TYPE' }" :selectionType="radio"></yu-xform-item>
            <yu-xform-item label="金融业务许可证" ctype="input" placeholder="金融业务许可证" name="bankProLic"></yu-xform-item>
        ...
        <yu-panel title=" 注册登记信息">
          <yu-xform-group :column="3">
            ...
            <yu-xform-item label="是否长期" ctype="select" data-code="STD_ZB_YES_NO" placeholder="是否长期" name="isLt"></yu-xform-item>
            ...
            <yu-xform-item label="营业执照到期日" ctype="datepicker" placeholder="营业执照到期日" name="expDateEnd"></yu-xform-item>
            ...
            <yu-xform-item label="注册地行政区划" ctype="input" placeholder="注册地行政区划" name="regiAreaCode"></yu-xform-item>
            ...
            <yu-xform-item label="注册地址" ctype="input" placeholder="注册地址" name="comRegAdd"></yu-xform-item>
            ...
            <yu-xform-item label="经营范围" ctype="input" placeholder="经营范围" name="natBusi"></yu-xform-item>
            ...
            <yu-xform-item label="经营地区" ctype="input" placeholder="经营地区" name="operArea"></yu-xform-item>
            ...
            <yu-xform-item label="主管机构" ctype="input" placeholder="主管机构" name="managerBrId" rules="required" hidden></yu-xform-item>
            <yu-xform-item label="主管机构" ctype="yu-xuser" placeholder="主管机构" name="managerBrName" @select-fn="commonSelectFn" :mapping="{ orgName: 'managerBrName', orgCode: 'managerBrId' }" width="550" height="480" :selectionType="radio"></yu-xform-item>
            <yu-xform-item label="管户客户经理" ctype="input" placeholder="管户客户经理" name="managerId" hidden></yu-xform-item>
            <yu-xform-item label="管户客户经理" ctype="yu-xuser" placeholder="管户客户经理" name="managerName" @select-fn="commonSelectFn" :mapping="{ loginCode: 'managerId', userName: 'managerName' }" width="550" height="480" :selectionType="radio"></yu-xform-item>
