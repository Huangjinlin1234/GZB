<template>
  <div>
    <yu-panel title="关联客户申请列表" panel-type="simple">
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" :base-params="{condition:{'oprType':'01', appType:'01'},'sort':'input_date desc'}" :default-load="false">
