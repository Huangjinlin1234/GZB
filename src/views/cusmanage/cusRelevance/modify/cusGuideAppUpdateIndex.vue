<template>
  <div>
    ...
    <div>
      <yu-form-buttons class="yubfp-button-group" style="text-align:center;" v-if="showAble">
...
export default {
  ...
  methods: {
    AfterInit () {
      ...
      if (this.bizPageData) {
        par = this.bizPageData.instanceInfo;
        par.serno = this.bizPageData.instanceInfo.bizId;
        this.showAble = false;
        this.d1_B_BillList.setBillListButtonVisable('onAdd2', false);
    ...
    // 选取申请
    onAdd () {
      this.$dialog.open('', 'cusmanage/cusRelevance/modify/cusXuanQuIndex', 800, 600, {}, data => {
