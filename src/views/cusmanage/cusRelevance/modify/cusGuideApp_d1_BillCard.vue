  ...
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="关联客户变更">
          <yu-xform-group :column="1">
            <yu-xform-item label="关联客户编号" ctype="yu-xcustom-ref" name="correCusId" rules="required" placeholder="关联客户编号" @select-fn="commonSelectFn" :mapping="{'correNo':'correNo','correCusId':'correCusId','correCusName':'correCusName'}" width="800" height="500" pagePath="cusmanage/cusRelevance/modify/cusXuanQuIndex" title="关联客户列表"></yu-xform-item>
