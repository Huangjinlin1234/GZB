      ...
      <div id="d1_A_BillCardContent">
        <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="申请类型" ctype="select" placeholder="申请类型" name="appType" data-code="STD_CUS_REL_APP_TYPE" disabled></yu-xform-item>
            ...
            <yu-xform-item label="审批状态" ctype="select" placeholder="审批状态" name="approveStatus" data-code="STD_ZB_APPR_STATUS" disabled></yu-xform-item>
            <yu-xform-item label="操作类型" ctype="select" placeholder="操作类型" name="oprType" data-code="STD_ZB_OPR_TYPE" hidden></yu-xform-item>
...
yufp.lookup.reg('STD_CUS_REL_APP_TYPE,STD_ZB_APPR_STATUS,STD_ZB_OPR_TYPE');
export default{
  name: 'D1ABillCard',
  mixins: [mixinForm],
  data: function () {
