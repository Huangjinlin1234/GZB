    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="关联成员客户编号" ctype="yu-xcustom-ref" name="correMemCusNo" placeholder="关联成员客户编号" @select-fn="commonSelectFn" :mapping="{'certType':'correMemCertType','cusId':'correMemCusNo','cusName':'correMemCusName','certCode':'correMemCertNo'}" width="800" height="500" pagePath="cusmanage/cusRelevance/dismiss/cusXuanQuIndex" title="自定义参照Title"></yu-xform-item>
