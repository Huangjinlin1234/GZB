  ...
  <div id="d1_A_BillCard">
    <yu-panel title="基本信息" panel-type="simple">
      <div id="d1_A_BillCardContent">
        <yu-xform ref="refForm" label-width="120px" :form-type="formType" :disabled="formDis" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
          ...
          <yu-xform-group :column="1">
            <yu-xform-item label="解散原因" ctype="textarea" name="resnMemo" rules="required" placeholder="解散原因"></yu-xform-item>
          </yu-xform-group>
        </yu-xform>
      </div>
    </yu-panel>
