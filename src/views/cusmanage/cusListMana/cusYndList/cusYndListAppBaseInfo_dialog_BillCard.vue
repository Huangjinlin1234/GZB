    ...
    <div id="dialog_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="本地户口" ctype="input" placeholder="本地户口" name="localRegist"></yu-xform-item>
          ...
          <yu-xform-item label="经办人" ctype="input" placeholder="经办人" name="huser"></yu-xform-item>
          <yu-xform-item label=" 经办机构" ctype="input" placeholder=" 经办机构" name="handOrg"></yu-xform-item>
          ...
          <yu-xform-item label=" 最近修改人" ctype="input" placeholder=" 最近修改人" name="lastUpdateId"></yu-xform-item>
          <yu-xform-item label=" 最近修改机构" ctype="input" placeholder=" 最近修改机构" name="lastUpdateBrId"></yu-xform-item>
