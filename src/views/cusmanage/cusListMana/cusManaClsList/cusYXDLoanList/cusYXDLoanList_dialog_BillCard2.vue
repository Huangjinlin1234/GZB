    ...
    <div id="dialog_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="客户经理" ctype="input" placeholder="客户经理" name="managerId" hidden></yu-xform-item>
          <yu-xform-item label="所属机构" ctype="input" placeholder="所属机构" name="belgOrg" hidden></yu-xform-item>
          <yu-xform-item label="客户经理" ctype="input" placeholder="客户经理" name="managerIdName"></yu-xform-item>
          <yu-xform-item label="所属机构" ctype="input" placeholder="所属机构" name="belgOrgName"></yu-xform-item>
          <yu-xform-item label="生效时间" ctype="input" placeholder="生效时间" name="inureDate"></yu-xform-item>
...
export default{
  ...
  data: function () {
    return {
      updateUrl: this.$backend.cmisCus + '/api/cusyxdloanlist/update',
      addUrl: this.$backend.cmisCus + '/api/cusyxdloanlist/',
      formdata: {},
      formType: 'edit',
      formRules: {
