<template>
  <div id="d1_BillCard">
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="备注" ctype="textarea" name="memo" rules="required" placeholder="备注" :colspan="24"></yu-xform-item>
    ...
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      ...
      <yu-button type="primary" @click="customClick('onCancel')">关闭</yu-button>
    </yu-form-buttons>
  </div>
</template>
<script>
...
export default{
  ...
  data: function () {
    return {
      ...
      formdata: {},
      formType: 'edit',
      formRules: { phone: [{validator: validator.telephone, message: '不是正确的固定电话和小灵通', trigger: 'blur'}] },
      imageUrls: {},
      File: {}
    };
  },
