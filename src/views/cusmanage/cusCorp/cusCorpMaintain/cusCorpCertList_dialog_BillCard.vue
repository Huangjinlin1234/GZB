    ...
    <div id="dialog_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item label="证件类型" ctype="select" rules="required" :options="dicOptions.certTypeOptions" placeholder="证件类型" name="certType"></yu-xform-item>
          ...
          <yu-xform-item label="资质等级" ctype="input" placeholder="资质等级" name="aptiLvl"></yu-xform-item>
