<template>
  <div>
    <yu-panel title="集团客户认定申请" panel-type="simple">
      ...
      <template>
        <yu-button type="primary" ref="btn_doInsert" v-if="checkCtrl('add')" @click="customClick('doInsert')">新增</yu-button>
...
export default{
  ...
  data: function () {
    return {
      ...
      baseParams: {condition: {'oprType': '01', appType: '01', managerId: this.$xutils.getDefaultformulaData('$LoginLoginCode')}, 'sort': 'app_date desc'},
