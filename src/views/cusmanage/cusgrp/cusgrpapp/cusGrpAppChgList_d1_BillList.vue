<template>
  <div>
    <yu-panel title="集团客户变更" panel-type="simple">
...
export default{
  ...
  data: function () {
    return {
      ...
      baseParams: {condition: {'oprType': '01', appType: '02', managerId: this.$xutils.getDefaultformulaData('$LoginLoginCode')}, 'sort': 'app_date desc'},
