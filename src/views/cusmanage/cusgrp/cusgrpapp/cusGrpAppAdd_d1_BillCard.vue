    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="1">
          ...
          <yu-xform-item label="集团名称" ctype="input" placeholder="集团名称" name="grpName" rules="required"></yu-xform-item>
          <yu-xform-item label="集团编号" ctype="input" placeholder="集团编号" name="grpNo" disabled hidden></yu-xform-item>
          <yu-xform-item label="核心客户编号" ctype="input" placeholder="核心客户编号" name="coreCusId" rules="required" icon="search" disabled :on-icon-click="handleIconClick"></yu-xform-item>
...
export default{
  ...
  methods: {
    execBillCardDefaultValueFormula: function () {
      this.formdata.appType = this.$xutils.getDefaultformulaData('01');
