    ...
    <div id="d1_BillCardContent">
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-xform-group :column="2">
          ...
          <yu-xform-item label="客户分类" ctype="input" disabled hidden placeholder="客户分类" name="cusRankCls"></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
    </div>
...
export default {
  ...
  methods: {
    execBillCardDefaultValueFormula: function () {
      ...
      this.formdata.cusType = this.$xutils.getDefaultformulaData('【类型=字典项】【内容=STD_ZB_CUS_TYP】');
