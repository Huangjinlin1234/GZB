      ...
      <yu-xform ref="pspCheckRstForm" v-model="rstData" label-width="120px">
        <yu-xform-group :column="1">
          <yu-panel title="检查结果及意见 " panel-type="simple">
            <yu-xform-item label="是否能收回贷款" :disabled="viewFlag||approveFlag||assistFlag" name="checkAdviceType" ctype="select" rules="required" data-code="STD_ZB_YES_NO"></yu-xform-item>
            <yu-xform-item label="目前及后期拟采取的清降措施" :disabled="viewFlag||approveFlag||assistFlag" name="checkAdviceReason" rules="required" ctype="textarea"></yu-xform-item>
          </yu-panel>
        </yu-xform-group>
      </yu-xform>
    </yu-panel>
