      ...
      <yu-panel title="借款人情况分析" :collapse-hide="false">
        <yu-xform ref="riskDebitAnalyForm" v-model="debitData" label-width="360px">
          <yu-xform-group :column="1">
            ...
            <yu-xform-item label="经营活动现金流量变动趋势" :disabled="viewFlag||approveFlag||assistFlag" ctype="radio" data-code="STD_RISK_CHG_TREND" name="operCashChange" rules="required"></yu-xform-item>
          </yu-xform-group>
        </yu-xform>
      </yu-panel>
    </yu-panel>
...
<script>
yufp.lookup.reg('STD_RISK_CHG_TREND');
