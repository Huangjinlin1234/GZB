  ...
  <div class="risk-task-list">
    <yu-panel :collapse-hide="false">
      ...
      <yu-panel ref="panel" :title="tableTitle" color="red" class="adjust-height" :collapse-hide="false">
        ...
        <!--任务主表显示列表-->
          <yu-xtable ref="riskTaskTable"  :data-url="listUrl" :base-params="searchData" requestType="POST" selection-type="radio" condition-key="condition">
            <yu-xtable-column align="center" label="任务编号" prop="taskNo"  width="150"></yu-xtable-column>
            <yu-xtable-column align="center" label="任务类型" prop="taskType" data-code="STD_RISK_TASK_TYPE" width="100"></yu-xtable-column>
            <yu-xtable-column align="center" label="分类模型" prop="checkType" data-code="STD_RISK_CHECK_TYPE" width="100"></yu-xtable-column>
            ...
            <yu-xtable-column align="center" label="任务执行机构" prop="execBrIdName" width="170"></yu-xtable-column>
...
export default {
  ...
  methods: {
    ...
    check: function (op) {
      ...
      // if (taskStatus == '1') {
      //   this.$message({ message: '任务数据生成中,请稍等!', type: 'warning' });
      //   return;
      // }
      let opType = op;
      let title = '个人消费性风险分类详情';
      let type = 'indivConsumeRiskTree';
