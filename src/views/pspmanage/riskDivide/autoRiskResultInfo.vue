    ...
    <yu-panel title="初分信息" panel-type="simple">
      <yu-xform ref="riskResultForm" v-model="rstData" label-width="120px">
          <yu-xform-group :column="2">
            <yu-xform-item label="上次分类结果" disabled v-if="consumeFlag" ctype="select" data-code="STD_FIVE_CLASS" name="lastClassRst"></yu-xform-item>
            <yu-xform-item label="上次分类结果" disabled v-if="!consumeFlag" ctype="select" data-code="STD_TEN_CLASS" name="lastClassRst"></yu-xform-item>
            <yu-xform-item label="上次分类日期" disabled ctype="input" name="lastCheckDate"></yu-xform-item>
            <yu-xform-item label="本次分类结果" disabled v-if="consumeFlag" ctype="select" data-code="STD_FIVE_CLASS" name="manualClass"></yu-xform-item>
            <yu-xform-item label="本次分类结果" disabled v-if="!consumeFlag" ctype="select" data-code="STD_TEN_CLASS" name="manualClass"></yu-xform-item>
            <yu-xform-item label="本次分类日期" disabled ctype="input" name="manualTenClass"></yu-xform-item>
          </yu-xform-group>
      </yu-xform>
    </yu-panel>
  </div>
