...
<script>
import d1ABillcard from "./projectProgressEvalTool_d1_A_BillCard.vue";
import d1BBillcard from "./projectProgressEvalTool_d1_B_BillCard.vue";
...
export default {
  ...
  methods: {
    ...
    onEval() {
      ...
      this.$request({
        url: this.$backend.cmisEval + "/api/evaluate/projectprogress",
