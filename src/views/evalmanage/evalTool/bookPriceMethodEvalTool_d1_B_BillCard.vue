  ...
  <div id="d1_B_BillCard">
    <div id="d1_B_BillCardContent">
      <yu-xform ref="refForm" label-width="140px" :disabled="formType == 'details'" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-panel title="估值结果" panel-type="simple">
          <yu-xform-group :column="3">
            <yu-xform-item label="估值结果" ctype="yu-num" name="evalResult" disabled placeholder="估值结果" number-formatter="0,000.00" :maxlength="16" :min="0"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
      </yu-xform>
    </div>
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button type="primary" @click="addPageHandle" v-if="ctl.addPageHandle">返回估值结果</yu-button>
    </yu-form-buttons>
  </div>
</template>
<script>
