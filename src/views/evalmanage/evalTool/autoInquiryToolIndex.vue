...
<script>
import d1ABillcard from "./autoInquiryTool_d1_A_BillCard.vue";
import d1BBillcard from "./autoInquiryTool_d1_B_BillCard.vue";
// 自主询价法估值工具
...
export default {
  ...
  methods: {
    ...
    onEval() {
      ...
      this.$request({
        url: this.$backend.cmisEval + "/api/evaluate/autoInquiryEval",
