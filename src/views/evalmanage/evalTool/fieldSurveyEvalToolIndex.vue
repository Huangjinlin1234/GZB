...
<script>
import d1ABillcard from "./fieldSurveyEvalTool_d1_A_BillCard.vue";
import d1BBillcard from "./fieldSurveyEvalTool_d1_B_BillCard.vue";
export default {
  ...
  mounted() {
    this.$lookup.reg("STD_ZB_EVAL_TYPE");
    this.AfterInit();
  },
  methods: {
    AfterInit() {
