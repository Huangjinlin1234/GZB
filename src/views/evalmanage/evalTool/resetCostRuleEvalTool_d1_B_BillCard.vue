  ...
  <div id="d1_B_BillCard">
    <div id="d1_B_BillCardContent">
      <yu-xform ref="refForm" label-width="140px" :disabled="formType == 'details'" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        <yu-panel title="估值结果" resetCostRuleEvalTool_d1_B_BillCard panel-type="simple">
          <yu-xform-group :column="3">
            <yu-xform-item label="估值结果" ctype="input" placeholder="估值结果" name="evalResult" disabled :colspan="6"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
      </yu-xform>
    </div>
    <yu-form-buttons class="yubfp-button-group" style="text-align:center;">
      <yu-button type="primary" @click="addPageHandle" v-if="ctl.addPageHandle">返回结果</yu-button>
    </yu-form-buttons>
  </div>
</template>
<script>
