<template>
  ...
  <yu-tabs v-model="activeName" @tab-click="handleClick">
    ...
    <yu-tab-pane label="押品详情信息-机器设备" name="second">
      <guarMachEqui ref="guarMachEqui"></guarMachEqui>
    </yu-tab-pane>
...
export default {
  // 导入的组件
  components: { guarBaseInfoAdd, guarMachEqui, yufpNwfInit, mapState},
  data: function () {
    return {
      activeName: 'first'
    };
  ...
  methods: {
    ...
    onSave () {
      ...
      yufp.clone(_this.$refs.guarMachEqui.formdata, model.guarInfMachEqui);
      yufp.clone(_this.$refs.guarBaseInfoAdd.formdata, model.guarInfMachEqui);
      ...
      this.$xutils.request({
        // 同步请求
        async: true,
        url: this.$backend.cmisBiz + '/api/guarbaseinfo/saveByGuarBasicGuarInfMachEquiVo',
