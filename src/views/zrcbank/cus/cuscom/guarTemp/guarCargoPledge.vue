<template>
  ...
  <yu-tabs v-model="activeName" @tab-click="handleClick">
    ...
    <yu-tab-pane label="押品详情信息-存货" name="second">
      <guarCargoPledge ref="guarCargoPledge"></guarCargoPledge>
    </yu-tab-pane>
...
export default {
  // 导入的组件
  components: { guarBaseInfoAdd, guarCargoPledge, yufpNwfInit, mapState},
  data: function () {
    return {
      activeName: 'first'
    };
  ...
  methods: {
    ...
    onSave () {
      ...
      yufp.clone(_this.$refs.guarCargoPledge.formdata, model.guarInfCargoPledge);
      yufp.clone(_this.$refs.guarBaseInfoAdd.formdata, model.guarInfCargoPledge);
      ...
      this.$xutils.request({
        // 同步请求
        async: true,
        url: this.$backend.cmisBiz + '/api/guarbaseinfo/saveByGuarBasicCargoPledgeVo',
