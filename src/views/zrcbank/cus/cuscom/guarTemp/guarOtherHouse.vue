<template>
  ...
  <yu-tabs v-model="activeName" @tab-click="handleClick">
    ...
    <yu-tab-pane label="押品详情信息-其他用房" name="second">
      <guarOtherHouse ref="guarOtherHouse"></guarOtherHouse>
    </yu-tab-pane>
...
export default {
  // 导入的组件
  components: { guarBaseInfoAdd, guarOtherHouse, yufpNwfInit, mapState},
  data: function () {
    return {
      activeName: 'first'
    };
  ...
  methods: {
    ...
    onSave () {
      ...
      yufp.clone(_this.$refs.guarOtherHouse.formdata, model.guarInfOtherHouse);
      yufp.clone(_this.$refs.guarBaseInfoAdd.formdata, model.guarInfOtherHouse);
      ...
      this.$xutils.request({
        // 同步请求
        async: true,
        url: this.$backend.cmisBiz + '/api/guarbaseinfo/saveByGuarBasicGuarInfOtherHouseVo',
