...
<template>
  ...
  -->
  <div>
    <yu-panel title="法人客户额度调整" panel-type="simple">
...
export default {
  ...
  data: function () {
    return {
      ...
      dataParam: { condition: JSON.stringify({ cusType: '2' }) },
      dataUrl:
  ...
  mounted () {
    ...
    this.dataParam = {
      condition: JSON.stringify({ oprType: '01', cusType: '2' })
  ...
  methods: {
          ...
          if (code == 0) {
            ...
            _this.$nextTick(function () {
              this.$router.addTab({
                // 路由名称
                name:
                  'zrcbank/lmt/apprStrMtableChgApp/apprStrMtableChgAppDetail',
    ...
    modifyFn: function () {
      ...
      _this.$nextTick(function () {
        this.$router.addTab({
          // 路由名称
          name: 'zrcbank/lmt/apprStrMtableChgApp/apprStrMtableChgAppDetail',
          // 自定义唯一页签key,请统一使用custom_前缀开头
          key: routeKey,
          // 页签名称
          title: '法人客户额度调整详情',
