...
<template>
  ...
  -->
  <div>
    <yu-panel title="产品户买入返售（信用债）白名单历史管理">
      ...
      <yu-xtable ref="refTable" condition-key="condition" row-number :data-url="dataUrl" :base-params="Param" requestType="POST">
        <yu-xtable-column label="金融机构代码" prop="instuCde" width="" data-code="STD_ZB_INSTU_CDE"></yu-xtable-column>
        ...
        <yu-xtable-column label="机构类型" prop="cusType" width="120" data-code="STD_ZB_INTB_TYPE"></yu-xtable-column>
    ...
    <yu-xdialog :title="viewTitle[viewType]" :visible.sync="dialogVisible" width="650px">
      <yu-xform ref="refForm" label-width="120px" v-model="formdata" :disabled="formDisabled">
        <yu-xform-group>
          ...
          <yu-xform-item label="客户号" name="cusId" ctype="input" :rules="rule[0]" icon="search" disabled></yu-xform-item>
          ...
          <yu-xform-item label="创建时间" name="createTime" ctype="input" disabled></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
    </yu-xdialog>
  </div>
