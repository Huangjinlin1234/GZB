<template>
  ...
  <div>
    <yu-tabs v-model="activeName">
      <yu-tab-pane label="单户债权转让登记" name="base">
          ...
          <template slot="filter">
            <yu-xform related-table-name="refTable" form-type="search" v-model="formdata" label-width="120px">
              <yu-xform-group :column="2">
                ...
                <yu-xform-item label="登记状态"  name="regiStatus" ctype="select" :options="docTypeOptions"></yu-xform-item>
                <yu-xform-item label="转让协议编号" name="takeoverAgrNo" placeholder="模糊查询" fuzzy-query="both"></yu-xform-item>
              </yu-xform-group>
            </yu-xform>
          </template>
        </yu-panel>
        <yu-panel title="单户债权转让登记列表" :hideFilter="false" :collapseHide="false" style="margin-top:20px">
          <yu-button-drop>
          ...
          <yu-xtable ref="refTable" condition-key="condition" style="margin-top:10px" row-number :data-url="dataUrl" :base-params="baseParams1" selection-type="radio" requestType="POST">
            <yu-xtable-column align="center" label="业务流水号" prop="ptaiSerno"></yu-xtable-column>
            ...
            <yu-xtable-column align="center" label="资产交割日期" prop="assetPayDate" v-if="false"></yu-xtable-column>
            ...
            <yu-xtable-column align="center" label="币种" prop="curType" data-code="STD_ZB_CUR_TYP" v-if="false"></yu-xtable-column>
            <yu-xtable-column align="center" label="贷款余额" prop="loanBalance" :formatter="Currency" width="120"></yu-xtable-column>
            <yu-xtable-column align="center" label="欠息金额" prop="totalTqlxAmt" :formatter="Currency" width="120"></yu-xtable-column>
      ...
      <yu-tab-pane label="单户债权转让登记历史" name="two">
        <yu-panel title="查询条件" :hideFilter="false" :collapseHide="false">
          <template slot="filter">
            <yu-xform related-table-name="refHisTable" form-type="search" v-model="formdata" label-width="120px">
              <yu-xform-group :column="2">
        ...
        <yu-panel title="单户债权转让登记历史列表" :hideFilter="false" :collapseHide="false" style="margin-top:20px">
          <yu-button-drop>
...
// 注册字典项
yufp.lookup.reg('STD_REGI_STATUS,STD_TAKEOVER_MODE,STD_ZB_CUR_TYP');
export default {
  ...
  data: function () {
    return {
      ...
      baseParams1: {condition: { regiStatus: '01,03,04', transferType: '01'}, sort: 'createTime desc'},
      baseParams2: {condition: { regiStatus: '02', transferType: '01'}, sort: 'createTime desc'},
      docTypeOptions: [
        {key: '01', value: '未登记'},
        // {key:"03", value:"登记中"},
        {key: '04', value: '登记失败'}
  ...
  methods: {
    ...
    *登记冲正
    ...
    addFn: function () {
      ...
      _this.$router.addTab({
        // 路由名称
        name: 'zrcbank/npam/plaTokeOver/plaTokeOverGuide',
        // 自定义唯一页签key
    ...
    infoHisFn () {
      ...
      this.$router.addTab({
        name: 'zrcbank/npam/plaTokeOver/plaTokeOverDetil',
        key: 'detailplaLawBroke' + new Date().getTime() + 1, // 必传
        title: '单户转让详情',
        data: {
          ptaiSerno: ptaiSerno,
          viewType: 'DETAIL',
