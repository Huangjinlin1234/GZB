<template>
  ...
  -->
  <div>
    <yu-panel title="仲裁案件新增向导" :hideFilter="false" :collapseHide="false">
      <yu-xform ref="refForm" label-width="120px" v-model="formdata" style="text-align: center;">
        <yu-xform-group>
          ...
          <yu-xform-item label="客户名称"  placeholder="客户名称" name="cusName" rules="required" disabled></yu-xform-item>
        </yu-xform-group>
        <yu-button-drop>
      ...
      yufp.service.request({
        ...
        callback: function (code, message, response) {
          if (response.code == 0) {
            ...
            arbitrateCaseNo = response.data.arbitrateCaseNo;
            _this.$router.addTab({
              name: 'zrcbank/npam/plaLawArbitrate/plaLawArbitrateDetil',
              key: 'plaLawBrokeApp' + cusId, // 必传
              title: '仲裁案件新增',
              data: {
                cusId: cusId,
