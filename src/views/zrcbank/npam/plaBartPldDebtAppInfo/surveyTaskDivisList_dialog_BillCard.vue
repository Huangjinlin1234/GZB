      ...
      <yu-xform ref="refForm" label-width="120px" :form-type="formType"  v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent">
        ...
        <yu-panel title="贷款申请信息">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="贷款用途" ctype="select" placeholder="贷款用途" name="loanPurp" data-code="STD_ZB_LOAN_USE" :colspan="24"></yu-xform-item>
          </yu-xform-group>
        </yu-panel>
        <yu-panel title="分配的客户经理及所属片区信息">
          <yu-xform-group :column="2">
...
lookup.reg('STD_ZB_YES_NO,STD_ZB_BIZ_BELG,STD_DATA_SOUR,BELG_TEAM,STD_ZB_CERT_TYP,STD_ZB_LOAN_USE,APP_CHNL,STD_APP_CHNL');
export default{
  name: 'DialogBillCard',
  mixins: [mixinForm],
  data: function () {
