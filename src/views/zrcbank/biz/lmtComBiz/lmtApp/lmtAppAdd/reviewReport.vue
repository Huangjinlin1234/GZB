        ...
        <yu-xform ref="lmtBaseForm" label-width="160px" v-model="baseFormdata1" :disabled="type=='VIEW'||showSaveBtn" :form-type="viewType">
            ...
            <yu-panel title="3.用信条件与其他限制性条件" :hideFilter="false" :collapseHide="false">
              ...
              <yu-panel title="4.贷后管理要求" :hideFilter="false" :collapseHide="false">
                ...
                <div class="yu-toolBar">
                  <yu-button-group>
                    <yu-button type="primary" @click="addRef6" :disabled="isManAftLoan||showSaveBtn">新增</yu-button>
                    <yu-button type="primary" @click="deleteRef6" :disabled="isManAftLoan||showSaveBtn">删除</yu-button>
                    <yu-button type="primary" @click="saveRef6" :disabled="isManAftLoan||showSaveBtn">保存</yu-button>
...
yufp.lookup.reg('STD_ZB_CUS_TYP,STD_ZB_CERT_TYP,STD_ZB_GUAR_WAY,STD_EI_MODE,STD_REPAY_MODE,STD_CHRG_COLLECT_MODE,STD_LOAN_APPR_MODE,STD_ZB_CONC,STD_ZB_YES_NO');
export default {
  components: {},
  props: {
    pageParams: Object,
  ...
  data () {
    ...
    return {
      ...
      baseParams8: {serno: this.$route.params.serno, repayPlanDesc: '', isShowZroe: 0},
      dialogVisible: false,
      effType: '',
      replySubList: [], // 分项列表
      isManAftLoan: false,
