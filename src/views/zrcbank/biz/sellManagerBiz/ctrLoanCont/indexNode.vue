<template>
  <div>
    <el-tabs v-model="tabValue" @tab-click="tabClick" tab-position="left">
...
let data = {};
export default {
  components: {ctrLoanContView, imageSystem, contPrint, grtContIndex, ctrLoanContPiFu},
  name: 'InstanceInfo',
  props: {
    pageParams: Object,
    dialogId: String
  ...
  computed: {
      ...
      let imageBizParam = [
        {
          ...
          'index': {
            ...
            'dzyid': '',
            'docid': '',
            'businessid': this.pageParams.instanceInfo.bizId,
            'custconduct': '',
            'operid': '',
            'bzrid': '',
            'custconductname': '',
            ...
            'custtype': '',
            'loadtype': '',
            'contid': this.pageParams.instanceInfo.bizId,
            'orgname': '',
            'opername': '',
            'custid': '',
            'creditamount': '',
    ...
    gtrContParams: function () {
      let _this = this;
      return {op: 'VIEW', iqpSerno: _this.pageParams.instanceInfo.param.iqpSerno };
    },
    ctrLoanContPiFuParams: function () {
      let _this = this;
      return {iqpSerno: _this.pageParams.instanceInfo.param.iqpSerno };
    }
  },
  created () {
  ...
  methods: {
    ...
    submitFn: function (opType) {
      var bizType = this.pageParams.instanceInfo.bizType;
      var nodeId = this.pageParams.instanceInfo.nodeId;
      var serno = this.pageParams.instanceInfo.bizId;
    ...
    updatePageData: function () {
      ...
      this.$nextTick(function () {
        this.pageParams.instanceInfo.comment = comment;
      });
    },
