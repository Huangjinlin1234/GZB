...
export default {
  ...
  mounted () {
    ...
    // 2021年5月16日16:03:56 由于取不到参数 特对此进行修改  从路由里面去取 --wh
    // this.surveySerno = this.pageParams.pvpSerno;
    this.surveySerno = this.$route.meta.params.pvpSerno;
    // 2021年5月16日16:11:04 经调试 bug起因在点击修改页面之后就会自动去查询 这时候页面已经被渲染 但是参数还没带过来
    // this.surveySerno = this.spjlData.pvpSerno;
    // 2021年5月16日16:15:09 所有页面好像是同时渲染的 不行 从新换回路由
    this.AfterInit();
  },
  methods: {
    AfterInit () {
