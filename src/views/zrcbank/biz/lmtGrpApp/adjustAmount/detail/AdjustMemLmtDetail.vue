<template>
  <!--
    @created by xiamc
    @description 额度成员信息，少一个成员额度调剂说明
  -->
  <div>
    <yu-row :gutter="24">
       <yu-xtable ref="refTable" row-number :data-url="`${$backend.cmisBiz}/api/lmtgrpmemrel/getMemrelList?ids=1`" type="selection">
        ...
        <yu-xtable-column label="敞口额度" prop="managerBrId" width="110"></yu-xtable-column>
        <yu-xtable-column label="低风险额度" prop="inputBrId" width="110"></yu-xtable-column>
        <yu-xtable-column label="管户客户经理" prop="pageviews" width="100"></yu-xtable-column>
        <yu-xtable-column label="所属机构" prop="pageviews" width="100"></yu-xtable-column>
        <yu-xtable-column label="客户经理提交状态" prop="pageviews" width="100"></yu-xtable-column>
        <yu-xtable-column label="是否包含预授信额度" prop="pageviews" width="100"></yu-xtable-column>
        <yu-xtable-column label="本次是否细化" prop="pageviews" width="100"></yu-xtable-column>
        <yu-xtable-column label="操作" prop="pageviews" width="100"></yu-xtable-column>
      </yu-xtable>
      <yu-col :span="24">
        <yu-xtable :data="treeTableData" style="width: 100%;margin-bottom: 20px;" row-key="pkId" border :tree-props="{children: 'lmtAppSubPrdList', hasChildren: 'hasChildren'}">
          ...
          <yu-xtable-column prop="cusName" label="所属成员名称"></yu-xtable-column>
          <yu-xtable-column prop="cusId" label="授信分项流水号" sortable width="180"></yu-xtable-column>
          <yu-xtable-column prop="cusName" label="授信分项额度编号" sortable width="180"></yu-xtable-column>
          ...
          <yu-xtable-column prop="isRevolvLimit" label="调剂前授信额度"></yu-xtable-column>
          <yu-xtable-column prop="isRevolvLimit" label="调剂后授信额度"></yu-xtable-column>
