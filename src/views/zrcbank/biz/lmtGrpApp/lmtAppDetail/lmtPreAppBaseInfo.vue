      ...
      <yu-col :span="19">
        ...
        <yu-panel title="原授信批复信息" is-collapse>
          <yu-xform ref="refForm1" label-width="100px" v-model="baseFormdata2">
            <yu-xform-group>
              <yu-xform-item label="原授信批复编号" ctype="input" name="origiLmtReplySerno" colspan="20" disabled="true"></yu-xform-item>
...
export default {
  data: function() {
    return {
      ...
      data: [{ id: "0", label: "成员客户预授信细化", pid: "-1" }, { id: "1", label: "授信方案信息", pid: "0" }, { id: "2", label: "关联信息", pid: "0" }, { id: "3", label: "授信基本信息", pid: "1" }, { id: "4", label: "授信分项明细", pid: "1" }],
      menuTreeData: [{ menuId: "0", menuName: "成员客户预授信细化", upMenuId: "-1", menuOrder: "5" }, { menuId: "1", menuName: "授信方案信息", upMenuId: "0", menuOrder: "5" }, { menuId: "2", menuName: "关联信息", upMenuId: "0", menuOrder: "5" }, { menuId: "3", menuName: "授信基本信息", upMenuId: "1", menuOrder: "5" }, { menuId: "4", menuName: "授信分项明细", upMenuId: "1", menuOrder: "5" }],
      searchFormdata: {},
