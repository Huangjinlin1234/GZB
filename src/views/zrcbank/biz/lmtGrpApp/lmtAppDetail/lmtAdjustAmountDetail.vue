  ...
  <div>
    <yu-panel title="授信基本信息" is-collapse>
      <yu-xform ref="refForm" label-width="100px" v-model="baseFormdata" :disabled="form1Disabled" >
        <yu-xform-group>
          ...
          <yu-xform-item label="业务类型" ctype="select" name="cusType" :rules="baseFormRules[1]" data-code="STD_SX_LMT_TYPE"></yu-xform-item>
          <yu-xform-item label="集团客户编号" ctype="input" name="grpCusId" :rules="baseFormRules[2]" data-code="EDUCATION_TYPE"></yu-xform-item>
          <yu-xform-item label="集团客户名称" ctype="input" name="grpCusName" :rules="baseFormRules[3]" data-code="IDENT_TYPE"></yu-xform-item>
          <yu-xform-item label="授信期限" ctype="input" name="lmtTerm" :rules="baseFormRules[4]"></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
    </yu-panel>
    <yu-panel title="授信成员信息" is-collapse>
      <yu-xtable ref="refTable" row-number :data-url="`${$backend.cmisBiz}/api/lmtgrpmemrel/getMemrelList?ids=1`" request-type="POST">
        ...
        <yu-xtable-column label="成员客户名称" prop="cusId" width="200" sortable></yu-xtable-column>
        <yu-xtable-column label="成员客户类型" prop="cusType" width="110" data-code="NATIONALITY"></yu-xtable-column>
        <yu-xtable-column label="管户客户经理" prop="managerBrId" width="110"></yu-xtable-column>
        <yu-xtable-column label="所属机构" prop="inputBrId" width="110"></yu-xtable-column>
        <yu-xtable-column label="授信额度是否可调剂" prop="pageviews" width="100"></yu-xtable-column>
        <yu-xtable-column label="本次是否调剂" prop="pageviews" width="100"></yu-xtable-column>
      </yu-xtable>
    </yu-panel>
     <yu-panel title="集团贷后管理要求" is-collapse>
      <yu-xform ref="refForm2" label-width="100px" v-model="baseFormdata2">
        <yu-xform-group>
          <yu-xform-item label="贷后管理要求" colspan="24" ctype="textarea" name="lmtReplySerno" rules="required"></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
    </yu-panel>
    <yu-panel title="原授信批复信息" is-collapse>
      <yu-xform ref="refForm1" label-width="100px" v-model="baseFormdata2" :disabled="form2Disabled">
        <yu-xform-group>
          <yu-xform-group>
            <yu-xform-item label="原授信批复编号" ctype="input" name="origiLmtReplySerno" :rules="baseFormRules[0]"></yu-xform-item>
            <yu-button type="primary" @click="viewFn">查看</yu-button>
          </yu-xform-group>
          <yu-xform-item label="原授信期限" ctype="input" name="origiLmtTerm" :rules="baseFormRules[1]"></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
    </yu-panel>
    <yu-panel title="登记信息" is-collapse>
      <yu-xform ref="refForm3" label-width="100px" v-model="baseFormdata3" :disabled="form3Disabled">
        <yu-xform-group>
          <yu-xform-item label="登记人" ctype="input" name="inputId" :rules="baseFormRules[0]"></yu-xform-item>
    ...
    <yu-xdialog :title="viewTitle[viewType]" :visible.sync="dialogVisible" width="650px">
      <yu-xform ref="refForm" label-width="120px" v-model="formdata" :disabled="formDisabled">
        <yu-xform-group column="3">
          <yu-xform-item label="集团客户名称" ctype="num" name="id" :hidden="true"></yu-xform-item>
          <yu-xform-item label="集团客户编号" rules="required" ctype="input" name="title"></yu-xform-item>
          <yu-xform-item label="批复编号" rules="required" ctype="input" name="createAt"></yu-xform-item>
        </yu-xform-group>
...
<script>
yufp.lookup.reg(
  'NATIONALITY,PUBLISH_STATUS,STD_SX_LMT_TYPE,EDUCATION_TYPE,IDENT_TYPE'
);
