...
<template>
  <div>
    <yu-panel title="项下业务" :hideFilter="false" :collapseHide="false">
      <yu-button-drop>
         <yu-button type="primary" @click="doView">查看</yu-button>
      </yu-button-drop>
      <yu-xtable ref="refTable" condition-key="condition" style="margin-top:10px" row-number selection-type="radio" :data-url="dataUrl" request-type="post" :default-load="false" :base-params="dataParam">
...
export default {
  ...
  mounted () {
    var _this = this;
    var contNo = _this.getFactory().contextData.contNo;
