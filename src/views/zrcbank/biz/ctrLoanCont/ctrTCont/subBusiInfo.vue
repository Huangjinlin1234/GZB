  ...
  <div class="tab-search">
    <yu-tabs v-model="activeName" @tab-click="handleClick">
        <yu-panel title="项下业务信息" :hideFilter="false" :collapseHide="false">
          ...
          <!--以下列表字段暂不确定-->
          <yu-xtable ref="refTable" row-number :data-url="dataUrl" condition-key="condition" request-type="POST" :data="bailaccinfo">
            ...
            <yu-xtable-column label="币种" prop="contCurType" width:="120" data-code="STD_ZB_CUR_TYP"></yu-xtable-column>
            <yu-xtable-column label="金额" prop="loanAmt" width:="120"></yu-xtable-column>
            <yu-xtable-column label="起始日" prop="startDate" width:="120"></yu-xtable-column>
            <yu-xtable-column label="到期日" prop="endDate" width:="120"></yu-xtable-column>
            <yu-xtable-column label="台账状态" prop="accStatus" data-code="STD_ACC_STATUS" width:="120"></yu-xtable-column>
          </yu-xtable>
        </yu-panel>
    </yu-tabs>
  </div>
...
yufp.lookup.reg('STD_ZB_ASSURE_MEANS,STD_ZB_CONT_TYP,STD_CONT_TYPE,STD_ZB_CUR_TYP,STD_ZB_YES_NO,STD_ZB_APPR_STATUS');
...
export default {
  data: function () {
    return {
      dataParam: {},
      // dataUrl: backend.cmisBiz + '/api/accloan/selectaccloanrepay',
  ...
  mounted () {
    var _this = this;
    var data = _this.getFactory().contextData;
    this.dataParam = { condition: JSON.stringify({ contNo: data.contNo }) };
    this.getAllBailData(this.dataParam);
  },
  methods: {
    ...
    getAllBailData: function (tableParams) {
      ...
      yufp.service.request({
        method: 'POST',
        url: backend.cmisBiz + '/api/accloan/selectaccloanrepay',
        data: tableParams,
