...
<template>
  ...
  -->
  <div>
    <yu-panel title="小企业标准化产品版" panel-type="simple">
      ...
      <yu-xtable ref="situBsLastTable" row-number :data="data" :pageable="false"  request-type="POST">
        ...
        <yu-xtable-column prop="briefDescription" label="备注" ctype="input" :disabled="op =='VIEW'"></yu-xtable-column>
      </yu-xtable>
      <yu-xform ref="situBsSmallBusiForm4" label-width="240px" v-model="formdataSituBsSmallBusi4">
  ...
  methods: {
    init: function () {
      ...
      yufp.service.request({
        ...
        data: {
          cusId: this.param.cusId, serno: this.param.serno, fncFlag: '5'
        },
