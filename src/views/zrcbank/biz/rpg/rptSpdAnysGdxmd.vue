<template>
  <div>
    <yu-panel title="固贷或项目贷款"  :hideFilter="false" :collapseHide="false">
          ...
          <yu-xform-group :column="2">
                ...
                <yu-xform-item label="固贷标识" ctype="input" name="flag" hidden="true"></yu-xform-item>
                ...
                <yu-xform-item label="项目概况、建设背景" ctype="input"  name="projectOverview"></yu-xform-item>
