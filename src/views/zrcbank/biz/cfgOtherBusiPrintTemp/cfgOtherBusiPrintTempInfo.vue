  ...
  methods: {
    ...
    ininForm: function (tempNo) {
      ...
      yufp.service.request({
        method: 'POST',
        url: backend.cmisCfg + '/api/cfgohterbusiprinttemp/querycfgohterbusiprinttempdatabyparams',
        data: {tempNo: tempNo},
    ...
    save () {
      ...
      yufp.service.request({
        method: 'POST',
        url: backend.cmisCfg + '/api/cfgohterbusiprinttemp/commonsavecfgohterbusiprinttempinfo',
