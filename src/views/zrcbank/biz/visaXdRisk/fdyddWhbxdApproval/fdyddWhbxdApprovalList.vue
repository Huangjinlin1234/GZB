        ...
        <yu-panel title="申请信息" :hideFilter="false" :collapseHide="false">
          <yu-xform ref="refForm" form-type="search" v-model="searchFormdata" label-width="120px" related-table-name="refTable">
            <yu-xform-group :column="4">
              <yu-xform-item label="流水号" placeholder="流水号" ctype="input" name="serno"></yu-xform-item>
              <yu-xform-item label="客户名称" placeholder="客户名称" ctype="input" name="cusName"></yu-xform-item>
              <yu-xform-item label="客户经理名称" placeholder="客户经理名称" ctype="input" name="managerName"></yu-xform-item>
          ...
          >
            ...
            <yu-xtable-column label="旧借据编辑" prop="oldBillNo" width:="120"></yu-xtable-column>
            <yu-xtable-column label="新借据编号" prop="newBillNo" width:="120"></yu-xtable-column>
            <yu-xtable-column label="新借据金额" prop="newLoanAmount" width:="120" :formatter="formatNumber('0,000.00',2)"></yu-xtable-column>
            <yu-xtable-column label="新借据起始日" prop="newStartDate" width:="120"></yu-xtable-column>
            <yu-xtable-column label="新借据到期日" prop="newEndDate" width:="120"></yu-xtable-column>
            <yu-xtable-column label="客户经理名称" prop="managerName" width:="120"></yu-xtable-column>
...
export default {
  data: function () {
    return {
      dataUrl: backend.cmisBiz + '/api/fdyddwhbxdapproval/fdyddWhbxdApprovallist',
      dataHisUrl: backend.cmisBiz + '/api/fdyddwhbxdapproval/fdyddWhbxdApprovalHislist',
   ...
   */
    ...
    infoFn: function () {
      ...
      params['op'] = 'VIEW';
      params['model_group_no'] = 'CMG000724';
    ...
    */
    updateFn: function () {
      ...
      if (params.approveStatus == '111') {
        _this.$xutils.showMsgBox('提示', '当前审批状态不可进行当前操作,请重试!');
        return;
      }
      let jsoPar = params;
      jsoPar['model_group_no'] = 'CMG000724';
      jsoPar['op'] = 'EDIT';
      var path = 'cfgmanage/productconfig/templetfactory/tempetfactorypreviewIndex';
      _this.$router.addTab({
        name: path,
