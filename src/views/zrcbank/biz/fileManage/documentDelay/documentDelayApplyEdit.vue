    ...
    <yu-tabs v-model="applyActiveName" @tab-click="handleClick">
      <yu-tab-pane label="档案延期申请信息" name="applyBase">
        ...
        <div class="yu-grpButton">
          <yu-button icon="yx-checkmark" type="primary" @click="submitApplyFn" >提交</yu-button>
...
export default {
  ...
  data: function () {
    return {
      ...
      baseParams: null,
      delayData: null,
      baseBussParams: {condition: JSON.stringify({ draiSerno: this.$route.meta.params.josnData.draiSerno, ifNeedDelay: 'true'}) },
  ...
  computed: {
    ...
    childParams: function () {
      let params = {
        serno: this.$route.meta.params.josnData.drdiSerno
      };
      return params;
    }
  },
  created () {
    ...
    _this.fineReportParam = {
      ...
      'index': '&drdiSerno=' + _this.$route.meta.params.josnData.drdiSerno
    };
  },
  mounted () {
    this.afterInit();
