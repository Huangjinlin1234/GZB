  ...
  <div>
    ...
    <yu-panel title="档案信息列表" panel-type="simple" is-collapse :collapse-title="collapseTitle">
      <yu-xtable ref="applyBussTable" row-number :data-url="applyBussDataUrl" request-type="POST" :base-params="baseBussParams">
        <yu-xtable-column label="档案编号" prop="docNo" width="150"></yu-xtable-column>
        <yu-xtable-column label="档案分类" prop="docClass" width="100" data-code="STD_DOC_CLASS"></yu-xtable-column>
        <yu-xtable-column label="档案类型" prop="docType" width="100" data-code="STD_DOC_TYPE"></yu-xtable-column>
        ...
        <yu-xtable-column label="入库操作人" prop="optUsrName" width="100" ></yu-xtable-column>
        <yu-xtable-column label="入库操作机构" prop="optOrgName" width="120"></yu-xtable-column>
        <yu-xtable-column label="入库操作时间" prop="optDate" width="120"></yu-xtable-column>
        <yu-xtable-column label="档案入现金库时间" prop="storageCashDate" width="150"></yu-xtable-column>
      </yu-xtable>
    </yu-panel>
...
export default {
  ...
  data: function () {
    return {
      ...
      applyBaseData: null,
      baseBussParams: {condition: JSON.stringify({ draiSerno: this.$route.meta.params.draiSerno}) },
      ifSave: false, // 是否已保存
  ...
  methods: {
    ...
    afterInit () {
      ...
      yufp.service.request({
        ...
        data: {'draiSerno': _this.$route.meta.params.draiSerno},
