...
<template>
  <div>
    <yu-panel title="查询条件" panel-type="normal">
      ...
      <yu-panel title="档案调阅接收列表" :hideFilter="false" :collapseHide="false" style="margin-top:40px">
      <div class="yu-toolBar">
            <yu-button type="primary" @click="docReceiveFn" v-if="checkCtrl('docReceiveFn')">接收</yu-button>
      ...
      <yu-xtable ref="applyTable" selection-type="radio" row-number :data-url="dataApplyListUrl" request-type="POST" condition-key="condition" :base-params="baseApplyParams">
        <yu-xtable-column label="调阅流水号" prop="draiSerno" width="120"></yu-xtable-column>
        <yu-xtable-column label="调阅形式" prop="readMode" width="100" data-code="STD_READ_MODE"></yu-xtable-column>
        <yu-xtable-column label="调阅原因" prop="readReason" width="100" data-code="STD_READ_REASON"></yu-xtable-column>
        <yu-xtable-column label="归还日期" prop="backDate" width="100" ></yu-xtable-column>
        <yu-xtable-column label="档案编号" prop="docNo" width="120"></yu-xtable-column>
        <yu-xtable-column label="档案分类" prop="docClass" width="120" data-code="STD_DOC_CLASS"></yu-xtable-column>
        <yu-xtable-column label="档案类型" prop="docType" width="120" data-code="STD_DOC_TYPE"></yu-xtable-column>
        ...
        <yu-xtable-column label="关联业务编号" prop="bizSerno" width="120" ></yu-xtable-column>
        <yu-xtable-column label="档案状态" prop="docStauts" data-code="STD_DOC_STAUTS"></yu-xtable-column>
        <yu-xtable-column label="调阅申请人" prop="readRqstrName" width="120"></yu-xtable-column>
        <yu-xtable-column label="调阅申请人机构" prop="readRqstrOrgName" width="120"></yu-xtable-column>
        <yu-xtable-column label="调阅申请日期" prop="readRqstrDate" width="120"></yu-xtable-column>
      </yu-xtable>
    </yu-panel>
  </div>
</template>
...
yufp.lookup.reg('YESNO,STD_DOC_CLASS,STD_DOC_TYPE,STD_READ_REASON,STD_READ_MODE,STD_DOC_STAUTS,STD_ZB_APPR_STATUS');
export default {
  mixins: [mixin],
  data: function () {
    return {
      ...
      baseApplyParams: {condition: JSON.stringify({ queryFlag: 'receiving' }) },
      viewType: 'DETAIL'
    };
  },
  // vuex中存储数据获取：
        ...
        callback: function (action) {
          if (action === 'confirm') {
            yufp.service.request({
              method: 'POST',
              data: drdiSerno,
              url: _this.$backend.cmisBiz + '/api/docreaddetailinfo/updateDocStsByReceive',
