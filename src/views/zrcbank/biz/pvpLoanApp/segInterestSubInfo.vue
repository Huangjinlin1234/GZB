...
yufp.lookup.reg('STD_ZB_OPER_TYPE,STD_RATE_ADJ_TYPE,STD_RATE_ADJ_TYPE,STD_LPR_RATE_INTVAL,STD_ZB_TERM_TYPE');
export default {
  ...
  methods: {
    ...
    saveFn: function () {
      ...
      var url = backend.cmisBiz + '/api/pvploanappseginterstsub/commonupdateseginterstsubinfo';
      // 向后台发送保存请求
      yufp.service.request({
        method: 'POST',
        url: url,
