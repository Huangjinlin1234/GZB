...
<template>
  ...
  <div>
    ...
    <div class="yu-grpButton">
        <yu-button type="primary" icon="check" @click="backToAdd">选取返回</yu-button>
        <yu-button type="primary" icon="yx-undo2" @click="cancel">取消</yu-button>
      </div>
    </yu-panel>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    init: function () {
      ...
      _this.urls.repayPlanInfoUrl = backend.cmisBiz + '/api/lmtappr/queryLmtApprSubDataByGrpSerno';// backend.cmisBiz + '/api/lmtappsubprd/selectAppSubPrdBySerno';
      _this.Param = {grpSerno: serno, repayPlanDesc: '01'};
    },
