...
export default{
  ...
  methods: {
    ...
    onPrint () {
      ...
      params.src = _this.$backend.frptRptService + '再议申请表（集团).cpt&op=view&SERNO=' + params.grpSerno;
      _this.$router.addTab({
        // 路由名称
        name: name,
...
export default {
  ...
  methods: {
    onPrint () {
      ...
      this.src = _this.$backend.frptRptService + 'DGSX-ZYSQB-JT.cpt&op=view&grpSerno=' + params.grpSerno;
    }
  }
};
</script>