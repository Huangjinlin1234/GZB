...
export default{
  ...
  methods: {
    ...
    onPrint () {
      ...
      params.src = _this.$backend.frptRptService + '授信变更申请书（集团）.cpt&op=view&SERNO=' + params.grpSerno;
      _this.$router.addTab({
        // 路由名称
        name: name,
...
export default {
  ...
  methods: {
    onPrint () {
      ...
      this.src = _this.$backend.frptRptService + 'DGSX-SXBGSQS-JT.cpt&op=view&grpSerno=' + params.grpSerno;
    }
  }
};
</script>