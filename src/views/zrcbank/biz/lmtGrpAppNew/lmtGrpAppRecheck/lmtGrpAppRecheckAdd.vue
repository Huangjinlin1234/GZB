...
export default {
  ...
  methods: {
    ...
    viewFn () {
      var _this = this;
      var grpReplySerno = _this.formdata.origiLmtReplySerno;
    ...
    tempSave: function () {
      var _this = this;
      var data = {};
      yufp.clone(_this.formdata, data);
      yufp.clone(_this.formdata, data);
      // 保存数据(期限)
      yufp.service.request({
        method: 'POST',
    ...
    commit: function () {
      var _this = this;
      var lmtTerm = _this.formdata.lmtTerm;
      var origiLmtTerm = _this.formdata.origiLmtTerm;
      if (lmtTerm > origiLmtTerm) {
        _this.$message('授信期限不得大于原授信期限');
        return;
      }
      var grpSerno = _this.formdata.grpSerno;
      var data = {};
      yufp.clone(_this.formdata, data);
      // 保存数据(期限)
      yufp.service.request({
