...
<template>
  ...
  -->
  <div>
    <yu-panel title="账务机构选择" :hideFilter="false" :collapseHide="false">
      <yu-xtable ref="ctrLoanTable" row-number row-key="pkId" condition-key="condition" :data-url="urls.ctrLoanInfoUrl" :base-params="Param" request-type="POST" :default-load="false" :pageable="false">
        ...
        <yu-xtable-column label="账务机构名称" prop="finaBrName"></yu-xtable-column>
    </yu-xtable>
  ...
  methods: {
    ...
    init: function () {
      ...
      _this.urls.ctrLoanInfoUrl =
        backend.cmisBiz + '/api/iqpentrustloanapp/selectsorgfina';
