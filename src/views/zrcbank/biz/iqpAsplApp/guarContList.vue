  ...
  <div style="margin-bottom: 20px;">
      <yu-panel title="担保合同信息" :hideFilter="false" :collapseHide="false">
        ...
        <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl" request-type="POST" :base-params="grtGuarContParams">
          ...
          <yu-xtable-column label="担保合同中文编号" prop="guarContCnNo" hide-column></yu-xtable-column>
...
export default {
  ...
  data: function () {
    return {
      ...
      searchFormdata: {},
      grtGuarContParams: {serno: this.$route.meta.params.serno || this.getFactory().contextData.instanceInfo.bizId},
