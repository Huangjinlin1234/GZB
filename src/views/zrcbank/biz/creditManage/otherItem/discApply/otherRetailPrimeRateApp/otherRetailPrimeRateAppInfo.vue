        ...
        <yu-tabs v-model="activeName" @tab-click="handleClick">
          <yu-tab-pane label="申请信息" name="basicTab">
            ...
            <yu-panel title="客户信息" :hideFilter="false" :collapseHide="false">
              <yu-xform-group :column="2">
                <yu-xform-item label="客户编号" ctype="yu-retail" name="cusId" rules="required" placeholder="客户编号" @select-fn="commonSelectFn" :mapping="{'cusId':'cusId','cusName':'cusName','certCode':'certCode'}" width="900" height="900" :parms="{'cusState':'2','managerId':this.$xutils.getLoginUserInfo().loginCode}" ></yu-xform-item>
            ...
            <yu-panel title="是否关联信息" :hideFilter="false" :collapseHide="false">
             <yu-xform-group :column="2">
                <yu-xform-item label="关联授信流水" ctype="iqp-loan-app-retail" name="iqpSerno"  placeholder="关联授信流水" @select-fn="commonSelectFn" :mapping="{'iqpSerno':'iqpSerno','appAmt':'appAmt','appTerm':'appTerm','execRateYear':'offerRate','guarWay':'guarMode','execRateYear':'appRate',}" width="900" height="900"></yu-xform-item>
            </yu-xform-group>
            </yu-panel>
            <yu-panel title="申请信息" :hideFilter="false" :collapseHide="false">
              <yu-xform-group :column="2">
                ...
                <yu-xform-item label="报价利率"  name="offerRate" :precision="6"  ctype="yu-num" rules="required"   placeholder="报价利率" sign="%" :multiple="100" ></yu-xform-item>
                <yu-xform-item label="申请执行利率"  name="appRate" :precision="6"  ctype="yu-num" rules="required"   placeholder="申请执行利率" sign="%" :multiple="100" ></yu-xform-item>
...
export default {
  ...
  methods: {
    ...
    submitProcessFun: function (params) {
      ...
      // 村镇银行
      if (loginUser.org.orgType == 'A') { // 是否保全客户经理岗
