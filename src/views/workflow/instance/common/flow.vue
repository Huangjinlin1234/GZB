...
export default {
  ...
  created() {
    ...
    if (null !== this.pagedata) {
      // if (this.pagedata.flowParam) {
      //   for (var k in this.pagedata.flowParam) {
      //     var key = this.pagedata.flowParam[k].key;
      //     this.flowParam[key] = this.pagedata.flowParam[k].value;
      //   }
      // }
      this.flowParam = this.pagedata.flowParam;
      this.instanceIdInfo = this.pagedata.instanceInfo;
      this.optypeOptions = this.pagedata.optypeOptions;
    }
  },
  mounted: function() {},
  methods: {
