...
<script>
import d1ABillcard from './ctrCvrgContAdd_d1_A_BillCard.vue';
import d1BBilllist from './ctrCvrgContAdd_d1_B_BillList.vue';
...
export default {
  ...
  methods: {
    ...
    AfterInit () {
      ...
      this.d1_B_BillList = this.$refs.d1_B_BillList; // 创建列表
      ...
      this.d1_B_BillList.queryDataByCondition({ serno: param.serno });
      let guarMode = this.d1_A_BillCard.formdata.guarMode;
    ...
    onSign () {
      ...
      this.$xutils.request({
        ...
        url: this.$backend.cmisBiz + '/api/ctrcvrgcont/update',
