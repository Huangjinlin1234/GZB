    ...
    <yu-panel title="历史协议" :hideFilter="false" :collapseHide="false">
      <yu-xform ref="refForm" form-type="search" v-model="searchFormdata" label-width="120px" :custom-search-fn="customSearch">
        <yu-xform-group :column="3">
          <yu-xform-item label="协议编号" ctype="input" placeholder="协议编号" name="contNo"></yu-xform-item>
      ...
      <yu-xtable ref="refTable" row-number condition-key="condition" selection-type="radio" @row-click="onRowClick" @row-dblclick="onRowDBClick" @cell-click="onCellClick" :pageable="true" :data-url="dataUrl"
        ...
        <yu-xtable-column label="贴现协议金额（元）" prop="contAmt" width="100" :formatter="formatNumber('0,000.00',2)"></yu-xtable-column>
        <yu-xtable-column label="责任人" prop="managerIdName" width="50"></yu-xtable-column>
...
export default {
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/ctrdisccont/donesignlist',
      baseParams: {},
