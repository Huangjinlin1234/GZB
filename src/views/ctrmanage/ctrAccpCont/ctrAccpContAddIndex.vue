...
<script>
import d1ABillcard from './ctrAccpContAdd_d1_A_BillCard.vue';
import d1BBilllist from './ctrAccpContAdd_d1_B_BillList.vue';
export default {
  ...
  methods: {
    ...
    onSign () {
      ...
      const jsoPar = this.d1_A_BillCard.formdata;
      ...
      const paperDate = this.$xutils.dateFormat('yyyy-MM-dd', new Date(this.d1_A_BillCard.formdata.paperContSignDate));
      ...
      this.$xutils.request({
        ...
        url: this.$backend.cmisBiz + '/api/ctraccpcont/onSign',
