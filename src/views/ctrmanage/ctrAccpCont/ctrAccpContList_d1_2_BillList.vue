...
<script>
yufp.lookup.reg('STD_ZB_CUR_TYP,STD_ZB_GUAR_WAY,STD_CONT_STATUS,STD_CONT_TYPE,STD_PRD_TYPE_PROP');
...
export default {
  ...
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/ctraccpcont/donesignlist',
      baseParams: {},
      deleteUrl: this.$backend.cmisBiz + '/api/ctraccpcont/delete/'
    };
  },
  mounted: function () {
    // TODO 此处逻辑需要自行实现  add by liucheng3
    // 过滤申请状态，移除【未生效】数据字典
