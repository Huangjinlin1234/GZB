      ...
      <yu-xform ref="refForm" label-width="120px" :form-type="formType" v-model="formdata" :rules="formRules" :form-change="triggerEditChangeEvent" :disabled="true">
        <yu-panel title="基本信息" :hideFilter="false" :collapseHide="false">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="流水号" ctype="input" placeholder="流水号" name="iqpSerno" rules="required" disabled :colspan="12"></yu-xform-item>
            ...
            <yu-xform-item label="产品名称" ctype="input" placeholder="产品名称" name="prdName" rules="required" disabled :colspan="12" @mouseover.native="show()" @mouseout.native="hideNow()"></yu-xform-item>
        ...
        <yu-panel title="期限金额" :hideFilter="false" :collapseHide="false">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="合同期限" ctype="input" placeholder="合同期限" name="contTerm" rules="required" :colspan="12" disabled autofocus unit="月"></yu-xform-item>
        ...
        <yu-panel title="第三方信息" :hideFilter="false" :collapseHide="false">
          <yu-xform-group :column="2">
            ...
            <yu-xform-item label="" ctype="custom" name="get" colspan="2" :hidden="!isShowTrdDataFlg">
              <yu-button type="primary" @click="customClick('viewCoopCusName')" :disabled="op == 'VIEW'">查看</yu-button>
            </yu-xform-item>
          </yu-xform-group>
        </yu-panel>
...
<script>
yufp.lookup.reg('STD_LOAN_MODAL,STD_ZB_LOAN_PROP,STD_ZB_YES_NO,STD_ZB_BANK_ROLE,STD_ZB_REPAY_SEQ,STD_PRD_TYPE_PROP,STD_ZB_BIZ_TYP,STD_ZB_GUAR_WAY,STD_ZB_CUR_TYP,STD_LOAN_TYPE,STD_LOAN_USE_TYPE,DEBT_GRADE');
