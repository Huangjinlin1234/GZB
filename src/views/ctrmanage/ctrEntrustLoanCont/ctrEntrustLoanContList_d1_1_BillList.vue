    ...
    <yu-panel title="待签合同" :hideFilter="false" :collapseHide="false">
      <yu-xform ref="refForm" form-type="search" v-model="searchFormdata" label-width="120px" :custom-search-fn="customSearch">
        <yu-xform-group :column="4">
          ...
          <yu-xform-item label="合同状态" ctype="select" data-code="STD_CONT_TYPE" placeholder="合同状态" name="contStatus"></yu-xform-item>
        </yu-xform-group>
      </yu-xform>
      <yu-button-drop>
...
yufp.lookup.reg('STD_ZB_CUR_TYP,STD_CONT_STATUS,STD_ZB_GUAR_WAY');
export default {
  name: 'D11BillList',
  mixins: [mixinList],
  data: function () {
    return {
      ...
      dialogVisible: false,
      formType: 'ADD',
      dataUrl: this.$backend.cmisBiz + '/api/ctrentrustloancont/tosignlist',
      baseParams: {},
