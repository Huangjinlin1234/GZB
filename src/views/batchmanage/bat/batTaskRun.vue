<template>
  <!--
    ...
    @updated by 2021-07-07 19:35:26
    @description 任务运行管理-增删改查
  -->
  <div>
    <yu-panel title="任务运行管理列表" panel-type="simple">
      <yu-xform related-table-name="refTable" form-type="search" v-model="searchFormdata" label-width="120px">
        <yu-xform-group :column="3">
          ...
          <yu-xform-item placeholder="任务状态" name="taskStatus"  data-code="STD_RZ_TASK_STATUS" ctype="select">
...
export default {
  ...
  data: function() {
    return {
      searchFormdata: {},
      dataUrl: this.$backend.cmisBatch + '/api/battaskrun/query',
      updateUrl: this.$backend.cmisBatch + '/api/battaskrun/update',
      addUrl: this.$backend.cmisBatch + '/api/battaskrun/',
      batchDeleteUrl: this.$backend.cmisBatch + '/api/battaskrun/batchdelete/',
      formdata: {},
      rule: [
        {
          required: true,
