...
<template>
  <!--
    ...
    @updated by 2021-07-07 19:35:26
    @description 调度运行管理表-增删改查
  -->
  <div>
    <yu-panel title="调度运行管理表列表" panel-type="simple">
...
export default {
  ...
  data: function() {
    return {
      searchFormdata: {},
      dataUrl: this.$backend.cmisBatch + '/api/batcontrolrun/query',
      updateUrl: this.$backend.cmisBatch + '/api/batcontrolrun/update',
      addUrl: this.$backend.cmisBatch + '/api/batcontrolrun/',
      deleteUrl: this.$backend.cmisBatch + '/api/batcontrolrun/delete/',
      formdata: {},
      rule: [
        {
          required: true,
