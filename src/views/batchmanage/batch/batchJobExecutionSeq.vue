...
<template>
  <!--
    @created by creazyCder 2021-07-07 19:24:41
    @updated by 2021-07-07 19:24:41 
    @updated by 2021-07-07 19:24:41
    @description -增删改查
  -->
  <div>
...
export default {
  ...
  data: function() {
    return {
      searchFormdata: {},
      dataUrl: this.$backend.cmisBatch + '/api/batchjobexecutionseq/query',
      updateUrl: this.$backend.cmisBatch + '/api/batchjobexecutionseq/update',
      addUrl: this.$backend.cmisBatch + '/api/batchjobexecutionseq/',
      batchDeleteUrl: this.$backend.cmisBatch + '/api/batchjobexecutionseq/batchdelete/',
      formdata: {},
      rule: [
        {
          required: true,
