...
<template>
  <!--
    @created by creazyCder 2021-07-07 19:27:00
    @updated by 2021-07-07 19:27:00 
    @updated by 2021-07-07 19:27:00
    @description -增删改查
  -->
  <div>
...
export default {
  ...
  data: function() {
    return {
      searchFormdata: {},
      dataUrl: this.$backend.cmisBatch + '/api/batchjobseq/query',
      updateUrl: this.$backend.cmisBatch + '/api/batchjobseq/update',
      addUrl: this.$backend.cmisBatch + '/api/batchjobseq/',
      batchDeleteUrl: this.$backend.cmisBatch + '/api/batchjobseq/batchdelete/',
      formdata: {},
      rule: [
        {
          required: true,
