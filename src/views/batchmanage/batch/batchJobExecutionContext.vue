...
export default {
  ...
  data: function() {
    return {
      searchFormdata: {},
      dataUrl: this.$backend.cmisBatch + '/api/batchjobexecutioncontext/query',
      updateUrl: this.$backend.cmisBatch + '/api/batchjobexecutioncontext/update',
      addUrl: this.$backend.cmisBatch + '/api/batchjobexecutioncontext/',
      batchDeleteUrl: this.$backend.cmisBatch + '/api/batchjobexecutioncontext/batchdelete/',
      formdata: {},
      rule: [
        {
          required: true,
